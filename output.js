//Mon Sep 08 2025 15:23:42 GMT+0000 (Coordinated Universal Time)
...
const _0x327f58 = "1.1",
  _0x2ec4c8 = require("crypto-js"),
  _0x55061e = require("node-rsa"),
  _0x1b47ef = ["\n", "@"],
  _0x123507 = 0;
usid = 0;
class _0xb7dbde {
    ...
    return new Promise(async _0xda06a3 => {
      _0x3e62c3[_0x2861a6.toLowerCase()](_0x42cae7, async (_0x3e7a9a, _0x9eb20f, _0x1c115e) => {
        try {
          ...
          !_0x3e7a9a ? $.safeGet(_0x1c115e) ? _0x1c115e = JSON.parse(_0x1c115e) : _0x1c115e = _0x1c115e : _0x475b4f == undefined ? (console.log("请检查网络设置"), _0x1c115e = JSON.parse("{\"code\":\"99\"}")) : (await this.hqdl(), _0x1c115e = await this.task(_0x2861a6, _0x37dd8c, _0x5a0e49, _0x50185e));
          return _0xda06a3(_0x1c115e);
        }
      });
    });
  }
...
function _0x5a1661() {
  return new class {
    ...
    ["task"](_0x501030, _0xe5e338, _0x23a6e4, _0x26da24, _0x46dda4) {
      {
        ...
        _0x501030 == "post" && (delete _0x23a6e4["content-type"], delete _0x23a6e4["Content-type"], delete _0x23a6e4["content-Type"], $.safeGet(_0x26da24) ? _0x23a6e4["Content-Type"] = "application/json;charset=UTF-8" : _0x23a6e4["Content-Type"] = "application/x-www-form-urlencoded", _0x26da24 && (_0x23a6e4["Content-Length"] = $.lengthInUtf8Bytes(_0x26da24)));
        _0x501030 == "get" && (delete _0x23a6e4["content-type"], delete _0x23a6e4["Content-type"], delete _0x23a6e4["content-Type"], delete _0x23a6e4["Content-Length"]);
        _0x23a6e4.Host = _0xe5e338.replace("//", "/").split("/")[1];
        return new Promise(async _0x371980 => {
          {
    ...
    ["decodeUnicode"](_0x5d7874) {
      _0x5d7874 = _0x5d7874.replace(/\\u/g, "%u");
      return unescape(unescape(_0x5d7874));
    }
    ...
    ["timecs"]() {
      {
        ...
        JSON.stringify(_0x1cc9a1).indexOf(" ") >= 0 && (_0x1cc9a1 = _0x1cc9a1.replace(" ", "T"));
        return new Date(_0x1cc9a1).getTime() - 28800000;
      }
    }
    ...
    ["RSA"](_0x371397, _0x2413fe) {
      ...
      _0xad78e6.setOptions({
        "encryptionScheme": "pkcs1"
      });
      return _0xad78e6.encrypt(_0x371397, "base64", "utf8");
    }
...
async function _0x4e77bd(_0x262d75, _0x31c41f) {
  ...
  _0xb36bb7.setOptions({
    "encryptionScheme": "pkcs1"
  });
  return _0xb36bb7.encrypt(_0x262d75, "base64", "utf8");
}
