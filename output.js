//Tue Aug 26 2025 11:58:48 GMT+0000 (Coordinated Universal Time)
//Base:<url id="cv1cref6o68qmpt26ol0" type="url" status="parsed" title="GitHub - echo094/decode-js: JS混淆代码的AST分析工具 AST analysis tool for obfuscated JS code" wc="2165">https://github.com/echo094/decode-js</url>
//Modify:<url id="cv1cref6o68qmpt26olg" type="url" status="parsed" title="GitHub - smallfawn/decode_action: 世界上本来不存在加密，加密的人多了，也便成就了解密" wc="741">https://github.com/smallfawn/decode_action</url>
!function (e) {
  function t(t) {
    for (var n, s, a = t[0], u = t[1], c = t[2], h = 0, f = []; h < a.length; h++) {
      s = a[h];
      Object.prototype.hasOwnProperty.call(i, s) && i[s] && f.push(i[s][0]);
      i[s] = 0;
    }
    for (n in u) if (Object.prototype.hasOwnProperty.call(u, n)) {
      e[n] = u[n];
    }
  ...
  "1b4b22b88": function (e, t, r) {
    ...
    (function (r) {
      ...
      function u() {
        ...
        function _(e, t) {
          ...
          if (0 === r) {
            t.delegate = null;
            if ("throw" === t.method) {
              if (e.iterator.return && (t.method = "return", t.arg = 0, _(e, t), "throw" === t.method)) {
                return h;
              }
              t.method = "throw";
          ...
          var i = n.arg;
          return i ? i.done ? (t[e.resultName] = i.value, t.next = e.nextLoc, "return" !== t.method && (t.method = "next", t.arg = 0), t.delegate = null, h) : i : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, h);
        }
        function k(e) {
          var t = {
            tryLoc: e[0]
        ...
        e.mark = function (e) {
          Object.setPrototypeOf ? Object.setPrototypeOf(e, d) : (e.__proto__ = d, a(e, s, "GeneratorFunction"));
        ...
        P.prototype = {
          ...
          reset: function (e) {
            ...
            if (!e) {
              for (var t in this) if ("t" === t.charAt(0) && r.call(this, t) && !isNaN(+t.slice(1))) {
                this[t] = 0;
              }
            }
          },
          ...
          abrupt: function (e, t) {
            ...
            s.type = e;
            s.arg = t;
            return o ? (this.method = "next", this.next = o.finallyLoc, h) : this.complete(s);
          },
      ...
      function p(e) {
        return (Object.setPrototypeOf ? p = Object.getPrototypeOf.bind() : p = function (e) {
      ...
      function b(e, t) {
        if (e) {
          ...
          return "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? w(e, t) : 0;
        }
      }
      function w(e, t) {
      ...
      function S(e) {
        return ("function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? S = function (e) {
          return typeof e;
        } : S = function (e) {
        ...
        return function e(t, r, n) {
          ...
          1: [function (e, t, r) {
            var n = e("events").EventEmitter,
              i = e("./store"),
              o = e("./topic-alias-recv"),
              s = e("./topic-alias-send"),
              a = e("mqtt-packet"),
              ...
              y = ["ECONNREFUSED", "EADDRINUSE", "ECONNRESET", "ENOTFOUND"],
              b = {
                0: "",
            ...
            function w(e, t) {
              ...
              if (0 === n.length) {
                ...
                if (0 === (n = e.topicAliasSend.getTopicByAlias(r))) {
                  return new Error("Unregistered Topic Alias");
                }
                t.topic = n;
              }
              if (r) {
                delete t.properties.topicAlias;
              }
            }
            function _(e, t, r) {
              e.emit("packetsend", t);
              !a.writeToStream(t, e.stream, e.options) && r && r !== P ? e.stream.once("drain", r) : r && r();
            }
            function E(e, t, r, n) {
              var i,
                o = t;
              if ("publish" === o.cmd && (o = h(t), i = w(e, o))) {
                return r && r(i);
              }
            ...
            function I(e, t) {
              ...
              for (r in this.options = t || {}, g) 0 === this.options[r] ? this.options[r] = g[r] : this.options[r] = t[r];
              "string" == typeof t.clientId ? this.options.clientId = t.clientId : this.options.clientId = "mqttjs_" + Math.random().toString(16).substr(2, 8);
              5 === t.protocolVersion && t.customHandleAcks ? this.options.customHandleAcks = t.customHandleAcks : this.options.customHandleAcks = function () {
                arguments[3](0);
              };
              this.streamBuilder = e;
              0 === this.options.messageIdProvider ? this.messageIdProvider = new u() : this.messageIdProvider = this.options.messageIdProvider;
              this.outgoingStore = t.outgoingStore || new i();
              this.incomingStore = t.incomingStore || new i();
              this.queueQoSZero = 0 === t.queueQoSZero || t.queueQoSZero;
              ...
              t.topicAliasMaximum > 0 && (t.topicAliasMaximum > 65535 || (this.topicAliasRecv = new o(t.topicAliasMaximum)));
              this.on("connect", function () {
                ...
                !function t() {
                  ...
                  if (n) {
                    var i = !0;
                    (r = n.packet).messageId && 0 !== r.messageId && (s.messageIdProvider.register(r.messageId) || (i = !1));
                    i ? s._sendPacket(r, function (e) {
                      n.cb && n.cb(e);
                      t();
                    }) : t();
                  } else {
              ...
              this.on("close", function () {
                ...
                null !== s.pingTimer && (s.pingTimer.clear(), s.pingTimer = null);
            ...
            I.prototype._setupStream = function () {
              ...
              this.stream.on("close", function () {
                ...
                (e = t.outgoing) && Object.keys(e).forEach(function (t) {
                  if (e[t].volatile && "function" == typeof e[t].cb) {
              ...
              if (this.options.properties) {
                ...
                if (this.options.properties.authenticationMethod && this.options.authPacket && "object" === S(this.options.authPacket)) {
                  _(this, Object.assign({
                    cmd: "auth",
                    reasonCode: 0
            ...
            I.prototype._checkDisconnecting = function (e) {
              this.disconnecting && (e && e !== P ? e(new Error("client disconnecting")) : this.emit("error", new Error("client disconnecting")));
            ...
            I.prototype.publish = function (e, t, r, n) {
                    ...
                    case 2:
                      {
                        ...
                        o._sendPacket(a, 0, r.cbStorePut);
                        break;
                      }
                    default:
                      {
              ...
              (this._storeProcessing || this._storeProcessingQueue.length > 0 || !s()) && this._storeProcessingQueue.push({
                invoke: s,
            ...
            I.prototype.subscribe = function () {
              ...
              delete i.resubscribe;
              "string" == typeof i && (i = [i]);
              "function" != typeof s && (a = s, s = P);
              var c = p.validateTopics(i);
              if (null !== c) {
                v(s, new Error("Invalid topic " + c));
                return this;
              }
              ...
              Array.isArray(i) ? i.forEach(function (t) {
                if (!Object.prototype.hasOwnProperty.call(e._resubscribeTopics, t) || e._resubscribeTopics[t].qos < a.qos || o) {
                  ...
                  5 === u && (r.nl = a.nl, r.rap = a.rap, r.rh = a.rh, r.properties = a.properties);
                  n.push(r);
                }
                ...
                if (!Object.prototype.hasOwnProperty.call(e._resubscribeTopics, t) || e._resubscribeTopics[t].qos < i[t].qos || o) {
                  ...
                  5 === u && (r.nl = i[t].nl, r.rap = i[t].rap, r.rh = i[t].rh, r.properties = a.properties);
                  n.push(r);
                }
              });
              if (!n.length) {
              ...
              var h = function () {
                ...
                a.properties && (r.properties = a.properties);
                if (e.options.resubscribe) {
                  var i = [];
                  n.forEach(function (t) {
                    if (e.options.reconnectPeriod > 0) {
                      ...
                      5 === u && (r.nl = t.nl || !1, r.rap = t.rap || !1, r.rh = t.rh || 0, r.properties = t.properties);
                      e._resubscribeTopics[t.topic] = r;
                      i.push(t.topic);
                    }
                  });
                  e.messageIdToTopic[r.messageId] = i;
                }
                e.outgoing[r.messageId] = {
                  volatile: !0,
                  cb: function (e, t) {
                    if (!e) {
                      for (var r = t.granted, i = 0; i < r.length; i += 1) n[i].qos = r[i];
                    }
                    s(e, n);
                  }
                };
              ...
              (this._storeProcessing || this._storeProcessingQueue.length > 0 || !h()) && this._storeProcessingQueue.push({
                invoke: h,
                callback: s
              });
              return this;
            ...
            I.prototype.unsubscribe = function () {
              ...
              var n = t.shift(),
                ...
                o = t.pop();
              "string" == typeof n && (n = [n]);
              "function" != typeof i && (o = i, i = P);
              var s = p.validateTopics(n);
              if (null !== s) {
                v(i, new Error("Invalid topic " + s));
                return this;
              }
              if (e._checkDisconnecting(i)) {
                return this;
              }
              var a = function () {
                var t = e._nextId();
                ...
                "string" == typeof n ? r.unsubscriptions = [n] : Array.isArray(n) && (r.unsubscriptions = n);
                e.options.resubscribe && r.unsubscriptions.forEach(function (t) {
                  delete e._resubscribeTopics[t];
                });
                "object" === S(o) && o.properties && (r.properties = o.properties);
                e.outgoing[r.messageId] = {
                  volatile: !0,
                  cb: i
                };
              ...
              (this._storeProcessing || this._storeProcessingQueue.length > 0 || !a()) && this._storeProcessingQueue.push({
                invoke: a,
                callback: i
              });
              return this;
            ...
            I.prototype.end = function (e, t, r) {
              ...
              null != e && "boolean" == typeof e || (r = t || P, t = e, e = !1, "object" !== S(t) && (r = t, t = null, "function" != typeof r && (r = P)));
              "object" !== S(t) && (r = t, t = null);
              r = r || P;
              return this.disconnecting ? (r(), this) : (this._clearReconnect(), this.disconnecting = !0, !e && Object.keys(this.outgoing).length > 0 ? this.once("outgoingEmpty", setTimeout.bind(null, i, 10)) : i(), this);
            };
            ...
            I.prototype.reconnect = function (e) {
              var t = this,
                r = function () {
                  ...
                  t.incomingStore = t.options.incomingStore || new i();
                  t.outgoingStore = t.options.outgoingStore || new i();
                  t.disconnecting = !1;
                  t.disconnected = !1;
                  t._deferredReconnect = null;
                  t._reconnect();
                };
              this.disconnecting && !this.disconnected ? this._deferredReconnect = r : r();
              return this;
            };
            I.prototype._reconnect = function () {
              var e = this;
              this.emit("reconnect");
              this.connected ? this.end(function () {
                e._setupStream();
              }) : this._setupStream();
            };
            I.prototype._setupReconnect = function () {
              var e = this;
              if (!e.disconnecting && !e.reconnectTimer && e.options.reconnectPeriod > 0) {
                this.reconnecting || (this.emit("offline"), this.reconnecting = !0);
            ...
            I.prototype._cleanUp = function (e, t) {
              ...
              if (e) {
                0 === this.options.reconnectPeriod && this.options.clean && (r = this.outgoing) && Object.keys(r).forEach(function (e) {
                  if ("function" == typeof r[e].cb) {
                    r[e].cb(new Error("Connection closed"));
                    delete r[e];
                  }
                });
                this.stream.destroy();
              ...
              t && !this.connected && (this.stream.removeListener("close", t), t());
            };
            I.prototype._sendPacket = function (e, t, r) {
              ...
              var n = function (e, t) {
                if (5 === e.options.protocolVersion && "publish" === t.cmd) {
                  ...
                  if (e.topicAliasSend) {
                    if (r) {
                      if (0 !== n.length && !e.topicAliasSend.put(n, r)) {
                        return new Error("Sending Topic Alias out of range");
                      }
                    } else {
                      if (0 !== n.length) {
                        e.options.autoAssignTopicAlias ? (r = e.topicAliasSend.getAliasByTopic(n)) ? (t.topic = "", t.properties = k(k({}, t.properties), {}, {
                          topicAlias: r
                        })) : (r = e.topicAliasSend.getLruAlias(), e.topicAliasSend.put(n, r), t.properties = k(k({}, t.properties), {}, {
                          topicAlias: r
                        })) : e.options.autoUseTopicAlias && (r = e.topicAliasSend.getAliasByTopic(n)) && (t.topic = "", t.properties = k(k({}, t.properties), {}, {
                          topicAlias: r
                        }));
                      }
                    }
              ...
              if (n) {
                ...
                if (!this.connected) {
                  return "auth" === e.cmd ? (this._shiftPingInterval(), _(this, e, t)) : this._storePacket(e, t, r);
                }
            ...
            I.prototype._storePacket = function (e, t, r) {
              ...
              0 === (n.qos || 0) && this.queueQoSZero || "publish" !== n.cmd ? this.queue.push({
                packet: n,
                cb: t
              }) : n.qos > 0 ? (this.outgoing[n.messageId] ? t = this.outgoing[n.messageId].cb : t = null, this.outgoingStore.put(n, function (e) {
                if (e) {
                  return t && t(e);
                }
                r();
              ...
              if (e.properties) {
                if (e.properties.topicAliasMaximum) {
                  if (e.properties.topicAliasMaximum > 65535) {
                    return this.emit("error", new Error("topicAliasMaximum from broker is out of range"));
                  }
                  if (e.properties.topicAliasMaximum > 0) {
                    this.topicAliasSend = new s(e.properties.topicAliasMaximum);
                  }
                }
            ...
            I.prototype._handlePublish = function (e, t) {
              ...
              if (5 === this.options.protocolVersion && (e.properties && (r = e.properties.topicAlias), 0 !== r)) {
                if (0 === n.length) {
                  if (!(r > 0 && r <= 65535)) {
                    return this.emit("error", new Error("Received Topic Alias is out of range"));
                  }
                  var l = this.topicAliasRecv.getTopicByAlias(r);
                  if (!l) {
                    return this.emit("error", new Error("Received unregistered Topic Alias"));
                  }
                  n = l;
                } else {
                  if (!this.topicAliasRecv.put(n, r)) {
                    return this.emit("error", new Error("Received Topic Alias is out of range"));
                  }
                }
              }
                ...
                case 2:
                  {
                    u.customHandleAcks(n, i, e, function (r, n) {
                      ...
                      return r ? a.emit("error", r) : -1 === c.indexOf(n) ? a.emit("error", new Error("Wrong reason code for pubrec")) : n ? a._sendPacket({
                        cmd: "pubrec",
                        messageId: s,
                        reasonCode: n
                ...
                case 1:
                  {
                    u.customHandleAcks(n, i, e, function (r, o) {
                      r instanceof Error || (o = r, r = null);
                      return r ? a.emit("error", r) : -1 === c.indexOf(o) ? a.emit("error", new Error("Wrong reason code for puback")) : (o || a.emit("message", n, i, e), a.handleMessage(e, function (e) {
                        if (e) {
                          return t && t(e);
                        }
                        a._sendPacket({
              ...
              if (o && o !== P) {
                switch (n) {
                  ...
                  case "puback":
                    {
                      var a = e.reasonCode;
                      a && a > 0 && 16 !== a && ((t = new Error("Publish error: " + b[a])).code = a, o(t, e));
                ...
                (function r() {
                  ...
                  (function e() {
                    if (n) {
                      ...
                      var r,
                        i = n.read(1);
                      i ? t._packetIdsDuringStoreProcessing[i.messageId] ? e() : t.disconnecting || t.reconnectTimer ? n.destroy && n.destroy() : (t.outgoing[i.messageId] ? r = t.outgoing[i.messageId].cb : r = null, t.outgoing[i.messageId] = {
                        volatile: !1,
                        cb: function (t, n) {
                          r && r(t, n);
                          e();
            ...
            I.prototype._flushStoreProcessingQueue = function () {
              var e,
                t = m(this._storeProcessingQueue);
              try {
                for (t.s(); !(e = t.n()).done;) {
                  var r = e.value;
                  r.cbStorePut && r.cbStorePut(new Error("Connection closed"));
                  r.callback && r.callback(new Error("Connection closed"));
                }
              } catch (e) {
                t.e(e);
              } finally {
                      ...
                      for (var a in t.push(o), n.push(s), o) {
                        ...
                        if ("object" !== S(u) || null === u) {
                          ...
                          if (u instanceof Date) {
                            ...
                            if (u instanceof Map) {
                              s[a] = new Map(i(Array.from(u), e));
                            } else {
                              if (u instanceof Set) {
                                s[a] = new Set(i(Array.from(u), e));
                              } else {
            ...
            t.exports = function (e, t, r) {
              var s,
                a = function (e) {
                  ...
                  0 === t.objectMode && (t.objectMode = !(!0 === t.binary || 0 === t.binary));
                  return t;
                ...
                l = function (e, t, r) {
                  var n = "MQIsdp" === t.protocolId && 3 === t.protocolVersion ? "mqttv3.1" : "mqtt",
                    i = function (e, t) {
                      ...
                      "function" == typeof e.transformWsUrl && (r = e.transformWsUrl(r, e, t));
                      return r;
                    }(t, e),
                    o = new WebSocket(i, [n], r);
                ...
                h = function (e, t, r) {
                  ...
                  l.bufferedAmount > a && setTimeout(e, u, t, r, i);
              ...
              t.objectMode || (h._writev = y);
              h.on("close", function () {
                l.close();
              });
              var f = 0 !== l.addEventListener;
              function p() {
                s.setReadable(h);
                s.setWritable(h);
                s.emit("connect");
              ...
              function g(e) {
                var t = e.data;
                t instanceof ArrayBuffer ? t = n.from(t) : t = n.from(t, "utf8");
                h.push(t);
              }
              function y(e, t) {
              ...
              l.readyState === l.OPEN ? s = h : (s = s = i(0, 0, t), t.objectMode || (s._writev = y), f ? l.addEventListener("open", p) : l.onopen = p);
              s.socket = l;
              f ? (l.addEventListener("close", d), l.addEventListener("error", v), l.addEventListener("message", g)) : (l.onclose = d, l.onerror = v, l.onmessage = g);
              return s;
            };
          }, {
            buffer: 17,
          ...
          4: [function (e, t, r) {
            ...
            t.exports = function (e, t) {
              ...
              n.onMessage(function (e) {
                var t = e.data;
                t instanceof ArrayBuffer ? t = s.from(t) : t = s.from(t, "utf8");
                i.push(t);
              });
              n.onClose(function () {
                o.end();
          ...
          5: [function (e, t, r) {
            ...
            n.prototype.allocate = function () {
              var e = this.nextId++;
              65536 === this.nextId && (this.nextId = 1);
              return e;
            };
          ...
          8: [function (e, t, r) {
            ...
            s.prototype.del = function (e, t) {
              (e = this._inflights.get(e.messageId)) ? (this._inflights.delete(e.messageId), t(null, e)) : t && t(new Error("missing packet"));
              return this;
            };
            s.prototype.get = function (e, t) {
              (e = this._inflights.get(e.messageId)) ? t(null, e) : t && t(new Error("missing packet"));
              return this;
            };
            ...
            (function (r) {
              (function () {
                var n = e("../client"),
                  ...
                  s = {};
                function a(e, t, r) {
                  "object" !== S(e) || t || (t = e, e = null);
                  t = t || {};
                  if (e) {
                    var i = o.parse(e, !0);
                    null != i.port && (i.port = Number(i.port));
                    if (null === (t = Object.assign(i, t)).protocol) {
                  ...
                  (function (e) {
                    var t;
                    if (e.auth) {
                      (t = e.auth.match(/^(.+):(.+)$/)) ? (e.username = t[1], e.password = t[2]) : e.username = e.auth;
                    }
                  })(t);
                  ...
                  if (t.protocol) {
                    t.defaultProtocol = t.protocol;
                  }
                  var u = new n(function (e) {
                    t.servers && (e._reconnectCount && e._reconnectCount !== t.servers.length || (e._reconnectCount = 0), t.host = t.servers[e._reconnectCount].host, t.port = t.servers[e._reconnectCount].port, t.servers[e._reconnectCount].protocol ? t.protocol = t.servers[e._reconnectCount].protocol : t.protocol = t.defaultProtocol, t.hostname = t.host, e._reconnectCount++);
                    return s[t.protocol](e, t, r);
                  }, t);
                  u.on("error", function () {});
                  return u;
                }
          ...
          14: [function (e, t, r) {
            ...
            o.prototype.copy = function (e, t, r, i) {
              ...
              if (0 === r && i === this.length) {
                ...
                for (var h = 0; h < this._bufs.length; h++) {
                  this._bufs[h].copy(e, c);
                  c += this._bufs[h].length;
                }
                return e;
              }
              ...
              for (var f = s[0]; f < this._bufs.length; f++) {
                ...
                if (!(u > p)) {
                  this._bufs[f].copy(e, c, l, l + u);
                  c += p;
                  break;
                }
                this._bufs[f].copy(e, c, l);
                c += p;
                u -= p;
                l && (l = 0);
              }
            ...
            o.prototype.shallowSlice = function (e, t) {
              e = e || 0;
              "number" != typeof t ? t = this.length : t = t;
              e < 0 && (e += this.length);
              t < 0 && (t += this.length);
              if (e === t) {
                return this._new();
            ...
            o.prototype.indexOf = function (e, t, r) {
              0 === r && "string" == typeof t && (r = t, t = 0);
              if ("function" == typeof e || Array.isArray(e)) {
                throw new TypeError('The "value" argument must be one of type string, Buffer, BufferList, or Uint8Array.');
              }
              "number" == typeof e ? e = n.from([e]) : "string" == typeof e ? e = n.from(e, r) : this._isBufferList(e) ? e = e.slice() : Array.isArray(e.buffer) ? e = n.from(e.buffer, e.byteOffset, e.byteLength) : n.isBuffer(e) || (e = n.from(e));
              t = Number(t || 0);
              isNaN(t) && (t = 0);
              t < 0 && (t = this.length + t);
              t < 0 && (t = 0);
              ...
              for (var i = this._offset(t), o = i[0], s = i[1]; o < this._bufs.length; o++) {
                for (var a = this._bufs[o]; s < a.length;) if (a.length - s >= e.length) {
                  var u = a.indexOf(e, s);
                  if (-1 !== u) {
                    return this._reverseOffset([o, u]);
                  }
            ...
            o.prototype._match = function (e, t) {
              ...
              for (var r = 0; r < t.length; r++) if (this.get(e + r) !== t[r]) {
                return !1;
              }
              return !0;
            };
            (function () {
              ...
              for (var t in e) !function (t) {
                null === e[t] ? o.prototype[t] = function (e, r) {
                  return this.slice(e, e + r)[t](0, r);
                } : o.prototype[t] = function () {
                  var r = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : 0;
            ...
            (function (t) {
              (function () {
                ...
                function a(e, t, r) {
                  ...
                  if (null == e) {
                    throw TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + S(e));
                  }
                  if (q(e, ArrayBuffer) || e && q(e.buffer, ArrayBuffer)) {
                    return function (e, t, r) {
                      ...
                      var n;
                      (0 === t && 0 === r ? n = new Uint8Array(e) : 0 === r ? n = new Uint8Array(e, t) : n = new Uint8Array(e, t, r)).__proto__ = s.prototype;
                      return n;
                    }(e, t, r);
                  }
                  if ("number" == typeof e) {
                  ...
                  var i = function (e) {
                    if (s.isBuffer(e)) {
                      var t = 0 | h(e.length),
                        r = o(t);
                      0 === r.length || e.copy(r, 0, 0, t);
                      return r;
                    }
                    return 0 !== e.length ? "number" != typeof e.length || F(e.length) ? o(0) : l(e) : "Buffer" === e.type && Array.isArray(e.data) ? l(e.data) : 0;
                  }(e);
                  if (i) {
                    return i;
                  }
                ...
                function f(e, t) {
                  ...
                  if ("string" != typeof e) {
                    throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type ' + S(e));
                  }
                  var r = e.length,
                ...
                function d(e, t, r, n, i) {
                  ...
                  if ("number" == typeof t) {
                    t &= 255;
                    return "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : v(e, [t], r, n, i);
                  }
                  ...
                  for (var n = [], i = t; i < r;) {
                    ...
                    if (i + h <= r) {
                      switch (h) {
                        ...
                        case 2:
                          {
                            if (128 == (192 & (o = e[i + 1])) && (u = (31 & c) << 6 | 63 & o) > 127) {
                              l = u;
                            }
                            break;
                          }
                    ...
                    null === l ? (l = 65533, h = 1) : l > 65535 && (l -= 65536, n.push(l >>> 10 & 1023 | 55296), l = 56320 | 1023 & l);
                    n.push(l);
                    i += h;
                  }
                  return function (e) {
                ...
                !s.TYPED_ARRAY_SUPPORT && "undefined" != typeof console && console.error;
                ...
                s.alloc = function (e, t, r) {
                  return function (e, t, r) {
                    u(e);
                    return e <= 0 ? o(e) : 0 !== t ? "string" == typeof r ? o(e).fill(t, r) : o(e).fill(t) : o(e);
                  }(e, t, r);
                };
                ...
                s.prototype.compare = function (e, t, r, n, i) {
                  q(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength));
                  if (!s.isBuffer(e)) {
                    throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + S(e));
                  }
                  0 === t && (t = 0);
                  0 === r && (e ? r = e.length : r = 0);
                  0 === n && (n = 0);
                  0 === i && (i = this.length);
                ...
                s.prototype.slice = function (e, t) {
                  ...
                  (0 === t ? t = r : t = ~~t) < 0 ? (t += r) < 0 && (t = 0) : t > r && (t = r);
                  t < e && (t = e);
          ...
          19: [function (e, t, r) {
            t.exports = function (t) {
              ...
              function n(e, t) {
                var n = r(this.namespace + (0 === t ? ":" : t) + e);
                n.log = this.log;
                return n;
              }
              function i(e) {
              ...
              r.enable = function (e) {
                ...
                for (t = 0; t < i; t++) if (n[t]) {
                  "-" === (e = n[t].replace(/\*/g, ".*?"))[0] ? r.skips.push(new RegExp("^" + e.slice(1) + "$")) : r.names.push(new RegExp("^" + e + "$"));
                }
              };
              r.enabled = function (e) {
                ...
                var t, n;
                for (t = 0, n = r.skips.length; t < n; t++) if (r.skips[t].test(e)) {
                  return !1;
                }
                for (t = 0, n = r.names.length; t < n; t++) if (r.names[t].test(e)) {
                  return !0;
                }
                return !1;
              };
              ...
              (function () {
                ...
                f.prototype.setReadable = function (e) {
                  ...
                  if (this.destroyed) {
                    ...
                    this._drained = !0;
                    this._readable = e;
                    e._readableState ? this._readable2 = e : this._readable2 = (t = e, new i.Readable({
                      objectMode: !0,
                      highWaterMark: 16
                    }).wrap(t));
                ...
                f.prototype._write = function (e, t, r) {
                  if (!this.destroyed) {
                    return this._corked ? c(this, this._write.bind(this, e, t, r)) : e === u ? this._finish(r) : this._writable ? !1 === this._writable.write(e) ? this._ondrain = r : this.destroyed || r() : r();
                  }
                };
              ...
              (function () {
                ...
                t.exports = function e(t, o, s) {
                  ...
                  var a = t._writableState,
                    ...
                    l = o.writable || !1 !== o.writable && t.writable,
                    h = !1,
                    f = function () {
                      t.writable || p();
                    },
                    ...
                    m = function () {
                      if (!h) {
                        return (!c || u && u.ended && !u.destroyed) && (!l || a && a.ended && !a.destroyed) ? 0 : s.call(t, new Error("premature close"));
                      }
                    },
                    b = function () {
                      t.req.on("finish", p);
                  ...
                  })(t) ? (t.on("complete", p), t.on("abort", y), t.req ? b() : t.on("request", b)) : l && !a && (t.on("end", f), t.on("close", f));
                  (function (e) {
                    return e.stdio && Array.isArray(e.stdio) && 3 === e.stdio.length;
                  })(t) && t.on("exit", v);
                  t.on("end", d);
                  t.on("finish", p);
                  !1 !== o.error && t.on("error", g);
                  t.on("close", y);
                  return function () {
                    h = !0;
          ...
          22: [function (e, t, r) {
            ...
            function s() {
              this._events && Object.prototype.hasOwnProperty.call(this, "_events") || (this._events = n(null), this._eventsCount = 0);
              this._maxListeners = this._maxListeners || 0;
            }
            t.exports = s;
            s.EventEmitter = s;
            s.prototype._events = 0;
            s.prototype._maxListeners = 0;
            var a,
              u = 10;
            try {
              var c = {};
            ...
            function l(e) {
              return 0 === e._maxListeners ? s.defaultMaxListeners : e._maxListeners;
            }
            function h(e, t, r, i) {
              var o, s, a;
              ...
              (s = e._events) ? (s.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), s = e._events), a = s[t]) : (s = e._events = n(null), e._eventsCount = 0);
              if (a) {
                "function" == typeof a ? i ? a = s[t] = [r, a] : a = s[t] = [a, r] : i ? a.unshift(r) : a.push(r);
                if (!a.warned && (o = l(e)) && o > 0 && a.length > o) {
                  a.warned = !0;
                  ...
                  u.type = t;
                  u.count = a.length;
                  "object" === ("undefined" == typeof console ? "undefined" : S(console)) && console.warn;
                }
              } else {
                a = s[t] = r;
                ++e._eventsCount;
            ...
            s.prototype.removeAllListeners = function (e) {
              ...
              if (!r.removeListener) {
                0 === arguments.length ? (this._events = n(null), this._eventsCount = 0) : r[e] && (0 == --this._eventsCount ? this._events = n(null) : delete r[e]);
                return this;
              }
              if (0 === arguments.length) {
                var s,
                  a = i(r);
                for (o = 0; o < a.length; ++o) if ("removeListener" !== (s = a[o])) {
          ...
          23: [function (e, t, r) {
            ...
            r.write = function (e, t, r, n, i, o) {
              var s,
                ...
                d = n ? 1 : -1,
                v = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
              for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (isNaN(t) ? a = 1 : a = 0, s = l) : (s = Math.floor(Math.log(t) / Math.LN2), t * (u = Math.pow(2, -s)) < 1 && (s--, u *= 2), (s + h >= 1 ? t += f / u : t += f * Math.pow(2, 1 - h)) * u >= 2 && (s++, u /= 2), s + h >= l ? (a = 0, s = l) : s + h >= 1 ? (a = (t * u - 1) * Math.pow(2, i), s += h) : (a = t * Math.pow(2, h - 1) * Math.pow(2, i), s = 0)); i >= 8; e[r + p] = 255 & a, p += d, a /= 256, i -= 8);
          ...
          25: [function (e, t, r) {
            ...
            r.Container = r.Base = r.ContainerIterator = 0;
            var n = v(function e() {
              var t = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : e.NORMAL;
              g(this, e);
              this.iteratorType = t;
            });
            r.ContainerIterator = n;
            n.NORMAL = !1;
            n.REVERSE = !0;
            var i = function () {
              function e() {
          ...
          26: [function (e, t, r) {
            ...
            var n = e("../../ContainerBase/index"),
              i = function (e) {
                c(r, n.Base);
                var t = l(r);
                function r() {
                  var e,
                    n = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : 16,
                    i = arguments.length > 1 && 0 !== arguments[1] ? arguments[1] : function (e) {
                      for (var t, r = 0, n = ("string" != typeof e ? t = JSON.stringify(e) : t = e).length, i = 0; i < n; i++) {
          ...
          27: [function (e, t, r) {
            ...
            var i = n(e("./Base/index")),
              o = n(e("../SequentialContainer/Vector")),
              s = n(e("../TreeContainer/OrderedMap")),
              a = function (e, t) {
                c(n, e);
                var r = l(n);
                function n() {
                ...
                v(n, [{
                  ...
                  value: function () {
                    ...
                    if (!(this.bucketNum >= i.default.maxBucketNum)) {
                      ...
                      for (var n = Object.keys(this.hashTable), a = n.length, u = function (a) {
                          ...
                          if (1 === l) {
                            var h = c.front();
                            t[e.hashFunc(h[0]) & e.bucketNum - 1] = new o.default([h], !1);
                            return "continue";
                          }
                          var f = [],
                            p = [];
                  ...
                  key: "setElement",
                  value: function (e, t) {
                    var r = this.hashFunc(e) & this.bucketNum - 1,
                      i = this.hashTable[r];
                    if (i) {
                      var a = i.size();
                      if (i instanceof o.default) {
                        ...
                        i.pushBack([e, t]);
                        if (a + 1 >= n.treeifyThreshold) {
                          if (this.bucketNum <= n.minTreeifySize) {
                            this.length += 1;
                      ...
                      this.length += 1;
                      this.hashTable[r] = new o.default([[e, t]], !1);
                    }
                    if (this.length > this.bucketNum * n.sigma) {
                      this.reAllocate();
                    }
                  }
                }, {
                  key: "getElementByKey",
                  value: function (e) {
                    var t = this.hashFunc(e) & this.bucketNum - 1,
                      r = this.hashTable[t];
                    if (r) {
                      if (r instanceof s.default) {
                        return r.getElementByKey(e);
                      }
                      var n,
                        i = m(r);
                      try {
                  ...
                  value: function (e) {
                    ...
                    if (r) {
                      if (r instanceof o.default) {
                        ...
                        var c = r.size();
                        this.length += c - u;
                        c <= i.default.untreeifyThreshold && (this.hashTable[t] = new o.default(r));
                      }
                    }
                  }
                }, {
                  ...
                  value: function (e) {
                    ...
                    var n,
                      i = m(r);
                    try {
                      for (i.s(); !(n = i.n()).done;) if (n.value[0] === e) {
                        return !0;
                      }
                    } catch (e) {
                      i.e(e);
                    ...
                    return u().mark(function e() {
                      ...
                      return u().wrap(function (e) {
                        for (;;) switch (e.prev = e.next) {
                          case 0:
                            {
                              t = Object.values(this.hashTable);
                              r = t.length;
                              n = 0;
                            }
                          case 3:
            ...
            "../SequentialContainer/Vector": 36,
            "../TreeContainer/OrderedMap": 40,
            "./Base/index": 26
          }],
          28: [function (e, t, r) {
            var n = this && this.__importDefault || function (e) {
            ...
            var i = n(e("./Base/index")),
              o = n(e("../SequentialContainer/Vector")),
              s = n(e("../TreeContainer/OrderedSet")),
              a = function (e, t) {
                c(n, e);
                var r = l(n);
                function n() {
                ...
                v(n, [{
                  ...
                  value: function () {
                    ...
                    if (!(this.bucketNum >= i.default.maxBucketNum)) {
                      ...
                      for (var n = Object.keys(this.hashTable), a = n.length, u = function (a) {
                          ...
                          if (1 === l) {
                            var h = c.front();
                            t[e.hashFunc(h) & e.bucketNum - 1] = new o.default([h], !1);
                            return "continue";
                          }
                          var f = [],
                            p = [];
                  ...
                  value: function (e) {
                    ...
                    if (r) {
                      var n = r.size();
                      if (r instanceof o.default) {
                        if (!r.find(e).equals(r.end())) {
                          return;
                        }
                        r.pushBack(e);
                        if (n + 1 >= i.default.treeifyThreshold) {
                          if (this.bucketNum <= i.default.minTreeifySize) {
                            this.length += 1;
                            return this.reAllocate();
                          }
                      ...
                      this.hashTable[t] = new o.default([e], !1);
                      this.length += 1;
                    }
                    if (this.length > this.bucketNum * i.default.sigma) {
                      this.reAllocate();
                    }
                  }
                }, {
                    ...
                    if (r) {
                      ...
                      if (0 !== n) {
                        if (r instanceof o.default) {
                          ...
                          var a = r.size();
                          this.length += a - n;
                          a <= i.default.untreeifyThreshold && (this.hashTable[t] = new o.default(r));
                        }
                      }
                    }
                  }
              ...
              i = function (e) {
                ...
                function r() {
                  var e,
                    ...
                    i = arguments.length > 1 && 0 !== arguments[1] ? arguments[1] : function (e, t) {
                      return e > t ? -1 : e < t ? 1 : 0;
                    },
                    o = !(arguments.length > 2 && 0 !== arguments[2]) || arguments[2];
                  g(this, r);
                  (e = t.call(this)).cmp = i;
                  Array.isArray(n) ? o ? e.priorityQueue = y(n) : e.priorityQueue = n : (e.priorityQueue = [], n.forEach(function (t) {
                  ...
                  for (var s = e.length - 1 >> 1; s >= 0; --s) for (var a = s, u = a << 1 | 1; u < e.length;) {
                    var c = u,
                      l = c + 1,
                      h = c;
                    l < e.length && e.cmp(e.priorityQueue[c], e.priorityQueue[l]) > 0 && (h = l);
                    if (e.cmp(e.priorityQueue[a], e.priorityQueue[h]) <= 0) {
                      break;
                    }
                    var f = [e.priorityQueue[h], e.priorityQueue[a]];
                    e.priorityQueue[a] = f[0];
                    e.priorityQueue[h] = f[1];
                    u = (a = h) << 1 | 1;
                  }
                  return e;
                }
                v(r, [{
                  ...
                  value: function (e) {
                    ...
                    this.length += 1;
                    if (1 !== this.length) {
                      for (var t = this.length - 1; t > 0;) {
                        var r = t - 1 >> 1;
                        if (this.cmp(this.priorityQueue[r], e) <= 0) {
                          break;
                        }
                        this.adjust(r);
                        t = r;
                  ...
                  value: function () {
                    if (this.length) {
                      ...
                      for (var t = 0; t < this.length;) {
                        ...
                        var i = r;
                        n < this.length && this.cmp(this.priorityQueue[r], this.priorityQueue[n]) > 0 && (i = n);
                        if (this.cmp(this.priorityQueue[i], e) >= 0) {
                          break;
                        }
                        this.priorityQueue[t] = this.priorityQueue[i];
                        t = i;
                      }
                      this.priorityQueue[t] = e;
          ...
          30: [function (e, t, r) {
            ...
            var i = n(e("../SequentialContainer/Deque")),
              o = e("../ContainerBase/index"),
              s = function (e) {
                c(r, o.Base);
                var t = l(r);
                function r() {
                  var e,
                    n = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : [];
                  g(this, r);
                  (e = t.call(this)).queue = new i.default(n);
                  e.length = e.queue.size();
                  return e;
                }
                v(r, [{
                  key: "clear",
          ...
          32: [function (e, t, r) {
            ...
            r.RandomIterator = 0;
            var n = e("../../../utils/checkParams"),
              i = e("../../ContainerBase/index"),
              o = function (e) {
                ...
                function r(e, n, o, s, a) {
                  var u;
                  g(this, r);
                  (u = t.call(this, a)).node = e;
                  u.size = n;
                  u.getElementByPos = o;
                  u.setElementByPos = s;
                  u.iteratorType === i.ContainerIterator.NORMAL ? (u.pre = function () {
                    if (0 === this.node) {
                ...
                v(r, [{
                  key: "pointer",
                  get: function () {
                    (0, n.checkWithinAccessParams)(this.node, 0, this.size() - 1);
                    return this.getElementByPos(this.node);
                  },
                  set: function (e) {
                    (0, n.checkWithinAccessParams)(this.node, 0, this.size() - 1);
                    this.setElementByPos(this.node, e);
                  }
                }, {
                  key: "equals",
                  value: function (e) {
          ...
          34: [function (e, t, r) {
            ...
            r.DequeIterator = 0;
            var i = n(e("./Base/index")),
              o = e("../../utils/checkParams"),
              s = e("../ContainerBase/index"),
              a = e("./Base/RandomIterator"),
              h = function (e) {
            ...
            var p = function (e, t) {
              ...
              function n() {
                var e,
                  ...
                  o = arguments.length > 1 && 0 !== arguments[1] ? arguments[1] : 4096;
                g(this, n);
                (e = r.call(this)).first = 0;
                e.curFirst = 0;
                e.last = 0;
                e.curLast = 0;
                e.bucketNum = 0;
                e.map = [];
                if ("size" in i) {
                  "number" == typeof i.size ? t = i.size : t = i.size();
                } else {
                  if (!("length" in i)) {
                ...
                e.bucketSize = o;
                e.bucketNum = Math.max(Math.ceil(t / e.bucketSize), 1);
                for (var s = 0; s < e.bucketNum; ++s) e.map.push(new Array(e.bucketSize));
                var a = Math.ceil(t / e.bucketSize);
                e.first = e.last = (e.bucketNum >> 1) - (a >> 1);
                e.curFirst = e.curLast = e.bucketSize - t % e.bucketSize >> 1;
                i.forEach(function (t) {
                  return e.pushBack(t);
                });
                e.size = e.size.bind(f(e));
                e.getElementByPos = e.getElementByPos.bind(f(e));
                e.setElementByPos = e.setElementByPos.bind(f(e));
                return e;
              }
              v(n, [{
                key: "reAllocate",
                value: function () {
                  ...
                  e[e.length] = y(this.map[this.last]);
                  this.first = t;
                  this.last = e.length - 1;
                  for (var o = 0; o < t; ++o) e[e.length] = new Array(this.bucketSize);
                  this.map = e;
                  this.bucketNum = e.length;
                }
              }, {
                key: "getElementIndex",
                value: function (e) {
                  var t = this.curFirst + e + 1,
                    r = t % this.bucketSize,
                    n = r - 1,
                    i = this.first + (t - r) / this.bucketSize;
                  0 === r && (i -= 1);
                  i %= this.bucketNum;
                  n < 0 && (n += this.bucketSize);
                  return {
                ...
                key: "pushBack",
                value: function (e) {
                  this.length && (this.curLast < this.bucketSize - 1 ? this.curLast += 1 : this.last < this.bucketNum - 1 ? (this.last += 1, this.curLast = 0) : (this.last = 0, this.curLast = 0), this.last === this.first && this.curLast === this.curFirst && this.reAllocate());
                  this.length += 1;
                  this.map[this.last][this.curLast] = e;
                }
              }, {
                key: "popBack",
                value: function () {
                  if (this.length) {
                    this.map[this.last][this.curLast] = 0;
                    1 !== this.length && (this.curLast > 0 ? this.curLast -= 1 : this.last > 0 ? (this.last -= 1, this.curLast = this.bucketSize - 1) : (this.last = this.bucketNum - 1, this.curLast = this.bucketSize - 1));
                    this.length -= 1;
                  }
                }
              }, {
                key: "pushFront",
                value: function (e) {
                  this.length && (this.curFirst > 0 ? this.curFirst -= 1 : this.first > 0 ? (this.first -= 1, this.curFirst = this.bucketSize - 1) : (this.first = this.bucketNum - 1, this.curFirst = this.bucketSize - 1), this.first === this.last && this.curFirst === this.curLast && this.reAllocate());
                  this.length += 1;
                  this.map[this.first][this.curFirst] = e;
                }
              }, {
                key: "popFront",
                value: function () {
                  if (this.length) {
                    this.map[this.first][this.curFirst] = 0;
                    1 !== this.length && (this.curFirst < this.bucketSize - 1 ? this.curFirst += 1 : this.first < this.bucketNum - 1 ? (this.first += 1, this.curFirst = 0) : (this.first = 0, this.curFirst = 0));
                    this.length -= 1;
                  }
                }
              }, {
                ...
                value: function (e, t) {
                  (0, o.checkWithinAccessParams)(e, 0, this.length - 1);
                  var r = this.getElementIndex(e),
                    n = r.curNodeBucketIndex,
                ...
                key: "insert",
                value: function (e, t) {
                  var r = arguments.length > 2 && 0 !== arguments[2] ? arguments[2] : 1;
                  (0, o.checkWithinAccessParams)(e, 0, this.length);
                  if (0 === e) {
                ...
                value: function (e) {
                  var t = e.node;
                  this.eraseElementByPos(t);
                  return e.next();
                }
              }, {
                key: "find",
                value: function (e) {
                  for (var t = 0; t < this.length; ++t) if (this.getElementByPos(t) === e) {
                    return new h(t, this.size, this.getElementByPos, this.setElementByPos);
                  }
                  return this.end();
                }
              }, {
          ...
          35: [function (e, t, r) {
            ...
            r.LinkListIterator = r.LinkNode = 0;
            var i = n(e("./Base/index")),
              o = e("../../utils/checkParams"),
              s = e("../ContainerBase/index"),
              a = v(function e(t) {
            ...
            var h = function (e) {
              ...
              function r(e, n, i) {
                var o;
                g(this, r);
                (o = t.call(this, i)).node = e;
                o.header = n;
                o.iteratorType === s.ContainerIterator.NORMAL ? (o.pre = function () {
            ...
            var f = function (e, t) {
              ...
              v(n, [{
                ...
                value: function () {
                  ...
                  this.header.pre = this.header.next = 0;
                }
              }, {
                key: "begin",
                value: function () {
                ...
                key: "front",
                value: function () {
                  return this.head ? this.head.value : 0;
                }
              }, {
                key: "back",
                value: function () {
                  return this.tail ? this.tail.value : 0;
                }
              }, {
                key: "forEach",
                value: function (e) {
                  if (this.length) {
                    for (var t = this.head, r = 0; t !== this.header;) {
                      e(t.value, r++);
                      t = t.next;
                    }
                  }
                ...
                value: function (e) {
                  this.length += 1;
                  var t = new a(e);
                  this.tail ? (this.tail.next = t, t.pre = this.tail, this.tail = t) : (this.head = this.tail = t, this.header.next = this.head, this.head.pre = this.header);
                ...
                value: function () {
                  if (this.tail) {
                    this.length -= 1;
                    this.head === this.tail ? (this.head = this.tail = 0, this.header.next = 0) : (this.tail = this.tail.pre, this.tail && (this.tail.next = 0));
                    this.header.pre = this.tail;
                    this.tail && (this.tail.next = this.header);
                  }
                }
              }, {
                key: "setElementByPos",
                ...
                value: function () {
                  if (!(this.length <= 1)) {
                    for (var e = this.head, t = this.tail, r = 0; r << 1 < this.length;) {
                      var n = e.value;
                      e.value = t.value;
                      t.value = n;
                      e = e.next;
                ...
                value: function () {
                  if (!(this.length <= 1)) {
                    for (var e = this.head; e !== this.header;) {
                      for (var t = e; t.next && t.value === t.next.value;) {
                        t = t.next;
                        this.length -= 1;
                      }
                      e.next = t.next;
                ...
                value: function (e) {
                  this.length += 1;
                  var t = new a(e);
                  this.head ? (t.next = this.head, this.head.pre = t, this.head = t) : (this.head = this.tail = t, this.tail.next = this.header, this.header.pre = this.tail);
                ...
                value: function () {
                  if (this.head) {
                    this.length -= 1;
                    this.head === this.tail ? (this.head = this.tail = 0, this.header.pre = this.tail) : (this.head = this.head.next, this.head && (this.head.pre = this.header));
                    this.header.next = this.head;
                  }
                }
              }, {
          ...
          36: [function (e, t, r) {
            ...
            var p = function (e, t) {
              ...
              function n() {
                ...
                g(this, n);
                e = r.call(this);
                Array.isArray(t) ? (i ? e.vector = y(t) : e.vector = t, e.length = t.length) : (e.vector = [], t.forEach(function (t) {
                  return e.pushBack(t);
                }));
                e.size = e.size.bind(f(e));
                e.getElementByPos = e.getElementByPos.bind(f(e));
              ...
              v(n, [{
                ...
                value: function (e) {
                  (0, o.checkWithinAccessParams)(e, 0, this.length - 1);
                  this.vector.splice(e, 1);
                  this.length -= 1;
                }
              }, {
                key: "eraseElementByValue",
                value: function (e) {
                  for (var t = 0, r = 0; r < this.length; ++r) if (this.vector[r] !== e) {
                    this.vector[t++] = this.vector[r];
                  }
                ...
                value: function (e, t) {
                  var r,
                    n = arguments.length > 2 && 0 !== arguments[2] ? arguments[2] : 1;
                  (0, o.checkWithinAccessParams)(e, 0, this.length);
                  (r = this.vector).splice.apply(r, [e, 0].concat(y(new Array(n).fill(t))));
                  this.length += n;
                }
              }, {
                key: "find",
                value: function (e) {
                  for (var t = 0; t < this.length; ++t) if (this.vector[t] === e) {
                    return new h(t, this.size, this.getElementByPos, this.getElementByPos);
                  }
                  return this.end();
                }
              }, {
                ...
                key: "unique",
                value: function () {
                  for (var e = 1, t = 1; t < this.length; ++t) if (this.vector[t] !== this.vector[t - 1]) {
                    this.vector[e++] = this.vector[t];
                  }
            ...
            var n = e("../../ContainerBase/index"),
              i = function (e) {
                ...
                function r(e, i, o) {
                  var s;
                  g(this, r);
                  (s = t.call(this, o)).node = e;
                  s.header = i;
                  s.iteratorType === n.ContainerIterator.NORMAL ? (s.pre = function () {
          ...
          38: [function (e, t, r) {
            ...
            var n = function () {
              ...
              v(e, [{
                ...
                value: function () {
                  var t = this;
                  if (t.color === e.RED && t.parent.parent === t) {
                    t = t.right;
                  } else {
                    if (t.left) {
                ...
                value: function () {
                  var e = this.parent,
                    t = this.right,
                    r = t.left;
                  e.parent === this ? e.parent = t : e.left === this ? e.left = t : e.right = t;
                  t.parent = e;
                  t.left = this;
                  this.parent = t;
                  this.right = r;
                ...
                value: function () {
                  var e = this.parent;
                  this === e.left ? e.left = 0 : e.right = 0;
                }
              }]);
              return e;
            }();
          ...
          39: [function (e, t, r) {
            ...
            var i = n(e("./TreeNode")),
              o = e("../../ContainerBase/index"),
              s = e("../../../utils/checkParams"),
              a = function (e) {
                c(r, o.Container);
                var t = l(r);
                function r() {
                  var e,
                    n = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : function (e, t) {
                      return e < t ? -1 : e > t ? 1 : 0;
                    };
                  g(this, r);
                  (e = t.call(this)).root = 0;
                  e.header = new i.default();
                  e.inOrderTraversal = function (t, r) {
                    return 0 !== t && (!!e.inOrderTraversal(t.left, r) || !!r(t) || e.inOrderTraversal(t.right, r));
                  };
                  e.cmp = n;
                  return e;
                }
                v(r, [{
                  ...
                  value: function (e) {
                    for (;;) {
                      ...
                      if (e.color === i.default.RED) {
                        return e.color = i.default.BLACK;
                      }
                      if (e === t.left) {
                        var r = t.right;
                        if (r.color === i.default.RED) {
                          r.color = i.default.BLACK;
                          t.color = i.default.RED;
                          t === this.root ? this.root = t.rotateLeft() : t.rotateLeft();
                        } else {
                          if (r.color === i.default.BLACK) {
                            if (r.right && r.right.color === i.default.RED) {
                              r.color = t.color;
                              t.color = i.default.BLACK;
                              r.right.color = i.default.BLACK;
                              return t === this.root ? this.root = t.rotateLeft() : t.rotateLeft();
                            }
                        ...
                        var n = t.left;
                        if (n.color === i.default.RED) {
                          n.color = i.default.BLACK;
                          t.color = i.default.RED;
                          t === this.root ? this.root = t.rotateRight() : t.rotateRight();
                        } else {
                          if (n.left && n.left.color === i.default.RED) {
                            n.color = t.color;
                            t.color = i.default.BLACK;
                            n.left.color = i.default.BLACK;
                            return t === this.root ? this.root = t.rotateRight() : t.rotateRight();
                          }
                  ...
                  value: function (e) {
                    if (1 !== this.length) {
                      ...
                      this.header.left === t ? this.header.left = t.parent : this.header.right === t && (this.header.right = t.parent);
                      this.eraseNodeSelfBalance(t);
                      t.remove();
                      this.length -= 1;
                      this.root.color = i.default.BLACK;
                    } else {
                      this.clear();
                    }
                  }
                }, {
                  key: "insertNodeSelfBalance",
                  value: function (e) {
                    for (;;) {
                      var t = e.parent;
                      if (t.color === i.default.BLACK) {
                        return;
                      }
                      var r = t.parent;
                      if (t === r.left) {
                        ...
                        if (n && n.color === i.default.RED) {
                          n.color = t.color = i.default.BLACK;
                          if (r === this.root) {
                            return;
                          }
                        ...
                        if (e === t.right) {
                          e.color = i.default.BLACK;
                          e.left && (e.left.parent = t);
                          e.right && (e.right.parent = r);
                          t.right = e.left;
                          r.left = e.right;
                          e.left = t;
                          e.right = r;
                          ...
                          t.color = i.default.BLACK;
                          r === this.root ? this.root = r.rotateRight() : r.rotateRight();
                        }
                        r.color = i.default.RED;
                      } else {
                        var s = r.left;
                        if (s && s.color === i.default.RED) {
                          s.color = t.color = i.default.BLACK;
                          if (r === this.root) {
                            return;
                          }
                          r.color = i.default.RED;
                        ...
                        if (e === t.left) {
                          ...
                          t.color = i.default.BLACK;
                          r === this.root ? this.root = r.rotateLeft() : r.rotateLeft();
                        }
                        r.color = i.default.RED;
                      }
                      return;
                  ...
                  value: function (e, t, r) {
                    ...
                    if (0 !== s) {
                      if (s > 0) {
                        o.left = new i.default(e, t);
                        o.left.parent = o;
                        n = o.left;
                        this.header.left = n;
                      } else {
                        var a = this.header.right,
                          u = this.cmp(a.key, e);
                        if (0 === u) {
                          return a.value = t;
                        }
                        if (u < 0) {
                          a.right = new i.default(e, t);
                          a.right.parent = a;
                          n = a.right;
                          this.header.right = n;
                        } else {
                          if (0 !== r) {
                            ...
                            if (c !== this.header) {
                              ...
                              if (l > 0) {
                                ...
                                if (f < 0) {
                                  n = new i.default(e, t);
                                  0 === h.right ? (h.right = n, n.parent = h) : (c.left = n, n.parent = c);
                                }
                              }
                            }
                          }
                  ...
                  value: function (e, t) {
                    ...
                    if (r === this.header.left) {
                      return this.cmp(r.next().key, t) > 0 && (r.key = t, !0);
                    }
                    if (r === this.header.right) {
                      return this.cmp(r.pre().key, t) < 0 && (r.key = t, !0);
                    }
                    var n = r.pre().key;
                    if (this.cmp(n, t) >= 0) {
                      return !1;
          ...
          40: [function (e, t, r) {
            ...
            r.OrderedMapIterator = 0;
            var i = e("../ContainerBase/index"),
              o = e("../../utils/checkParams"),
              s = n(e("./Base/index")),
              h = n(e("./Base/TreeIterator")),
              p = function (e) {
                c(r, h.default);
                var t = l(r);
                function r() {
                ...
                v(r, [{
                  ...
                  get: function () {
                    ...
                    return new Proxy([], {
                      get: function (t, r) {
                        return "0" === r ? e.node.key : "1" === r ? e.node.value : 0;
                      },
                      set: function (t, r, n) {
                        if ("1" !== r) {
            ...
            var d = function (e, t) {
              ...
              function n() {
                var e,
                  ...
                  i = arguments.length > 1 ? arguments[1] : 0;
                g(this, n);
                (e = r.call(this, i)).iterationFunc = u().mark(function e(t) {
                  return u().wrap(function (e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        {
                ...
                e.iterationFunc = e.iterationFunc.bind(f(e));
                t.forEach(function (t) {
                  var r = a(t, 2),
                    n = r[0],
                    i = r[1];
              ...
              v(n, [{
                ...
                value: function (e) {
                  var t = this.findElementNode(this.root, e);
                  return 0 !== t ? new p(t, this.header) : this.end();
                }
              }, {
                key: "getElementByKey",
                value: function (e) {
          ...
          41: [function (e, t, r) {
            ...
            r.OrderedSetIterator = 0;
            var i = n(e("./Base/index")),
              o = e("../ContainerBase/index"),
              s = e("../../utils/checkParams"),
              a = n(e("./Base/TreeIterator")),
              h = function (e) {
                c(r, a.default);
                var t = l(r);
                function r() {
            ...
            var p = function (e, t) {
              ...
              v(n, [{
                ...
                key: "front",
                value: function () {
                  return this.header.left ? this.header.left.key : 0;
                }
              }, {
                key: "back",
                value: function () {
                  return this.header.right ? this.header.right.key : 0;
                }
              }, {
                key: "forEach",
                value: function (e) {
                ...
                value: function (e) {
                  var t = this.findElementNode(this.root, e);
                  return 0 !== t ? new h(t, this.header) : this.end();
                }
              }, {
                key: "lowerBound",
                value: function (e) {
          ...
          42: [function (e, t, r) {
            ...
            r.HashContainer = r.TreeContainer = r.SequentialContainer = r.ContainerIterator = r.Container = r.HashMap = r.HashSet = r.OrderedMapIterator = r.OrderedMap = r.OrderedSetIterator = r.OrderedSet = r.DequeIterator = r.Deque = r.LinkListIterator = r.LinkList = r.VectorIterator = r.Vector = r.PriorityQueue = r.Queue = r.Stack = 0;
          ...
          43: [function (e, t, r) {
            ...
            r.checkWithinAccessParams = 0;
            r.checkWithinAccessParams = function (e, t, r) {
              if (e < t || e > r) {
            ...
            var n = e("yallist"),
              ...
              y = function () {
                function e(t) {
                  ...
                  t || (t = {});
                  if (t.max && ("number" != typeof t.max || t.max < 0)) {
                    throw new TypeError("max must be a non-negative number");
                  }
                  this[i] = t.max || 1 / 0;
                  var r = t.length || d;
                  "function" != typeof r ? this[s] = d : this[s] = r;
                  this[a] = t.stale || !1;
                  if (t.maxAge && "number" != typeof t.maxAge) {
                ...
                v(e, [{
                  ...
                  set: function (e) {
                    ...
                    e !== this[s] && (this[s] = e, this[o] = 0, this[h].forEach(function (e) {
                      e.length = t[s](e.value, e.key);
                      t[o] += e.length;
                    }));
                    w(this);
                  }
                  ...
                  value: function (e, t, r) {
                    ...
                    if (this[f].has(e)) {
                      ...
                      this[c] && (this[l] || this[c](e, p.value));
                      p.now = n;
                      p.maxAge = r;
                      p.value = t;
                      this[o] += a - p.length;
              ...
              w = function (e) {
                if (e[o] > e[i]) {
                  for (var t = e[h].tail; e[o] > e[i] && null !== t;) {
                    var r = t.prev;
                    _(e, t);
                    t = r;
                  }
          ...
          45: [function (e, t, r) {
            (function (e) {
              (function () {
                  ...
                  return [0, 1, 2].map(function (n) {
                    return [0, 1].map(function (i) {
                      return [0, 1].map(function (o) {
                        var s = e.alloc(1);
                        s.writeUInt8(r.codes[t] << r.CMD_SHIFT | (i ? r.DUP_MASK : 0) | n << r.QOS_SHIFT | o, 0, !0);
                        return s;
                      });
                    });
                  });
                ...
                r.PUBLISH_HEADER = a("publish");
                r.SUBSCRIBE_HEADER = a("subscribe");
                ...
                r.UNSUBSCRIBE_HEADER = a("unsubscribe");
                r.ACKS = {
                  unsuback: a("unsuback"),
                  puback: a("puback"),
                  pubcomp: a("pubcomp"),
                ...
                var n = e("./writeToStream"),
                  ...
                  o = function (e) {
                    ...
                    function n() {
                      var e;
                      g(this, n);
                      (e = t.call(this))._array = new Array(20);
                      e._i = 0;
                      return e;
                    }
                    v(n, [{
                      ...
                      value: function () {
                        var e,
                          ...
                          i = this._array,
                          o = 0;
                        for (e = 0; e < i.length && 0 !== i[e]; e++) {
                          "string" != typeof i[e] ? n[e] = i[e].length : n[e] = r.byteLength(i[e]);
                          t += n[e];
                        }
                        var s = r.allocUnsafe(t);
                        for (e = 0; e < i.length && 0 !== i[e]; e++) "string" != typeof i[e] ? (i[e].copy(s, o), o += n[e]) : (s.write(i[e], o), o += n[e]);
                        return s;
                      }
                    }]);
                    return n;
              ...
              (function () {
                ...
                t.exports = {
                  ...
                  genBufVariableByteInt: function (t) {
                    ...
                    t > 0 && (i = 0);
                    return n ? o.subarray(0, i) : o.slice(0, i);
                  },
            ...
            var n = e("bl"),
              ...
              u = function (e) {
                ...
                function r() {
                  var e;
                  g(this, r);
                  (e = t.call(this)).parser = e.constructor.parser;
                  return e;
                }
                v(r, [{
                  key: "_resetState",
                  ...
                  value: function (e) {
                    ...
                    a("parse: exited while loop. packet: %d, buffer list length: %d", this.packet.length, this._list.length);
                  ...
                  value: function () {
                    ...
                    a("_parsePayload complete result: %s", e);
                    return e;
                  }
                }, {
                  key: "_parseConnect",
                  value: function () {
                    ...
                    o.protocolVersion >= 128 && (o.bridgeMode = !0, o.protocolVersion = o.protocolVersion - 128);
                    if (3 !== o.protocolVersion && 4 !== o.protocolVersion && 5 !== o.protocolVersion) {
                    ...
                    if (i.will) {
                      if (5 === o.protocolVersion) {
                        ...
                        if (Object.getOwnPropertyNames(h).length) {
                          o.will.properties = h;
                        }
                      }
                  ...
                  value: function () {
                    ...
                    e.sessionPresent = !!(this._list.readUInt8(this._pos++) & s.SESSIONPRESENT_MASK);
                  ...
                  value: function () {
                    ...
                    if (this._parseMessageId()) {
                      if (5 === this.settings.protocolVersion) {
                        ...
                        if (Object.getOwnPropertyNames(l).length) {
                          c.properties = l;
                        }
                      }
                      for (; this._pos < c.length;) {
                        ...
                        r = (t = this._parseByte()) & s.SUBSCRIBE_OPTIONS_QOS_MASK;
                        o = 0 != (t >> s.SUBSCRIBE_OPTIONS_NL_SHIFT & s.SUBSCRIBE_OPTIONS_NL_MASK);
                        i = 0 != (t >> s.SUBSCRIBE_OPTIONS_RAP_SHIFT & s.SUBSCRIBE_OPTIONS_RAP_MASK);
                        n = t >> s.SUBSCRIBE_OPTIONS_RH_SHIFT & s.SUBSCRIBE_OPTIONS_RH_MASK;
                        u = {
                          topic: e,
                          qos: r
                        };
                        5 === this.settings.protocolVersion ? (u.nl = o, u.rap = i, u.rh = n) : this.settings.bridgeMode && (u.rh = 0, u.rap = !0, u.nl = !0);
                        a("_parseSubscribe: push subscription `%s` to subscription", u);
                        c.subscriptions.push(u);
                      }
                    }
                  }
                }, {
                  ...
                  value: function () {
                    ...
                    if (this._parseMessageId()) {
                      ...
                      for (; this._pos < e.length;) {
                        ...
                        a("_parseUnsubscribe: push topic `%s` to unsubscriptions", r);
                  ...
                  value: function () {
                    ...
                    if (5 === this.settings.protocolVersion && (e.length > 2 ? (e.reasonCode = this._parseByte(), a("_parseConfirmation: packet.reasonCode `%d`", e.reasonCode)) : e.reasonCode = 0, e.length > 3)) {
                      var t = this._parseProperties();
                      if (Object.getOwnPropertyNames(t).length) {
                        e.properties = t;
                      }
                  ...
                  value: function () {
                    ...
                    a("_parseDisconnect result: true");
                    return !0;
                  }
                }, {
                  key: "_parseAuth",
                  ...
                  value: function () {
                    ...
                    return null === e.messageId ? (this._emitError(new Error("Cannot parse messageId")), !1) : (a("_parseMessageId: packet.messageId %d", e.messageId), !0);
                  }
                }, {
                  key: "_parseString",
                  value: function (e) {
                  ...
                  value: function (e) {
                    ...
                    for (var t, r = 0, n = 1, i = 0, o = !1, u = this._pos ? this._pos : 0; r < 4 && u + r < this._list.length;) {
                      i += n * ((t = this._list.readUInt8(u + r++)) & s.VARBYTEINT_MASK);
                      n *= 128;
                      if (0 == (t & s.VARBYTEINT_FIN_MASK)) {
                        o = !0;
                        break;
                      }
                    ...
                    !o && 4 === r && this._list.length >= r && this._emitError(new Error("Invalid variable byte integer"));
                    u && (this._pos += r);
                  ...
                  value: function () {
                    ...
                    for (var e = this._parseVarByteNum(), t = this._pos + e, r = {}; this._pos < t;) {
                      ...
                      if ("userProperties" !== i) {
                        r[i] ? (Array.isArray(r[i]) || (r[i] = [r[i]]), r[i].push(this._parseByType(s.propertiesTypes[i]))) : r[i] = this._parseByType(s.propertiesTypes[i]);
                      } else {
                  ...
                  value: function () {
                    a("_newPacket");
                    this.packet && (this._list.consume(this.packet.length), a("_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d", this.packet.cmd, this.packet.payload, this.packet.length), this.emit("packet", this.packet));
              ...
              (function () {
                    ...
                    case "connect":
                      {
                        return function (e, t, i) {
                          ...
                          g += 1;
                          if (("string" == typeof h || r.isBuffer(h)) && (h || a >= 4) && (h || c)) {
                            g += r.byteLength(h) + 2;
                          } else {
                            if (a < 4) {
                            ...
                            if (1 * c == 0) {
                              t.emit("error", new Error("clientId must be given if cleanSession set to 0"));
                              return !1;
                            }
                          }
                          ...
                          if (u) {
                            if ("object" !== S(u)) {
                              t.emit("error", new Error("Invalid will"));
                              return !1;
                            }
                          ...
                          if (null != p) {
                            if (!b) {
                              t.emit("error", new Error("Username is required to use password"));
                              return !1;
                            }
                            if (!R(p)) {
                          ...
                          var k = 0;
                          null != f ? k |= n.USERNAME_MASK : k |= 0;
                          null != p ? k |= n.PASSWORD_MASK : k |= 0;
                          u && u.retain ? k |= n.WILL_RETAIN_MASK : k |= 0;
                          u && u.qos ? k |= u.qos << n.WILL_QOS_SHIFT : k |= 0;
                          u ? k |= n.WILL_FLAG_MASK : k |= 0;
                          c ? k |= n.CLEAN_SESSION_MASK : k |= 0;
                          t.write(r.from([k]));
                          d(t, l);
                          5 === a && y.write();
                          I(t, h);
                          u && (5 === a && m.write(), _(t, u.topic), I(t, u.payload));
                          null != f && I(t, f);
                          null != p && I(t, p);
                          return !0;
                        }(e, t);
                    ...
                    case "publish":
                      {
                        return function (e, t, o) {
                          ...
                          if ("string" == typeof h) {
                            ...
                            if (!r.isBuffer(h)) {
                              t.emit("error", new Error("Invalid topic"));
                              return !1;
                            }
                            g += h.length + 2;
                          }
                          r.isBuffer(f) ? g += f.length : g += r.byteLength(f);
                    ...
                    case "subscribe":
                      {
                        return function (e, t, i) {
                          ...
                          for (var v = 0; v < l.length; v += 1) {
                            ...
                            if (5 === o) {
                              if ("boolean" != typeof (l[v].nl || !1)) {
                                t.emit("error", new Error("Invalid subscriptions - invalid No Local"));
                                return !1;
                              }
                              if ("boolean" != typeof (l[v].rap || !1)) {
                                t.emit("error", new Error("Invalid subscriptions - invalid Retain as Published"));
                                return !1;
                              }
                              var b = l[v].rh || 0;
                              if ("number" != typeof b || b > 2) {
                                t.emit("error", new Error("Invalid subscriptions - invalid Retain Handling"));
                                return !1;
                              }
                            }
                          ...
                          try {
                            for (P.s(); !(k = P.n()).done;) {
                              var I = k.value,
                                ...
                                B = 0;
                              _(t, A);
                              B = n.SUBSCRIBE_OPTIONS_QOS[T];
                              5 === o && (O ? B |= n.SUBSCRIBE_OPTIONS_NL : B |= 0, C ? B |= n.SUBSCRIBE_OPTIONS_RAP : B |= 0, R ? B |= n.SUBSCRIBE_OPTIONS_RH[R] : B |= 0);
                              E = t.write(r.from([B]));
                            }
                          } catch (e) {
                            P.e(e);
                ...
                function w(e, t) {
                  if (t > n.VARBYTEINT_MAX) {
                    e.emit("error", new Error("Invalid variable byte integer: ".concat(t)));
                    return !1;
                  }
                  var r = b[t];
                  r || (r = f(t), t < 16384 && (b[t] = r));
                  ...
                  function o(t, i) {
                    ...
                    switch (n.propertiesTypes[t]) {
                      case "byte":
                        {
                          if ("boolean" != typeof i) {
                            e.emit("error", new Error("Invalid ".concat(t, ": ").concat(i)));
                            return !1;
                          }
                          o += 2;
                          break;
                      ...
                      case "pair":
                        {
                          ...
                          o += Object.getOwnPropertyNames(i).reduce(function (e, t) {
                            var n = i[t];
                            Array.isArray(n) ? e += n.reduce(function (e, n) {
                              return e + (3 + r.byteLength(t.toString()) + 2 + r.byteLength(n.toString()));
                            }, 0) : e += 3 + r.byteLength(t.toString()) + 2 + r.byteLength(i[t].toString());
                            return e;
                          }, 0);
                          break;
                        }
                      default:
                        {
                          e.emit("error", new Error("Invalid property ".concat(t, ": ").concat(i)));
                          return !1;
                        }
                    }
                    return o;
                ...
                function T(e, t, i) {
                  switch (n.propertiesTypes[t]) {
                    ...
                    default:
                      {
                        e.emit("error", new Error("Invalid property ".concat(t, " value: ").concat(i)));
                        return !1;
                      }
                  }
                }
                function O(e, t, r) {
                  for (var n in w(e, r), t) if (Object.prototype.hasOwnProperty.call(t, n) && null !== t[n]) {
                    var i = t[n];
                    if (Array.isArray(i)) {
                      for (var o = 0; o < i.length; o++) T(e, n, i[o]);
                    } else {
                      T(e, n, i);
                    }
                  }
          ...
          54: [function (e, t, r) {
            ...
            a.prototype.alloc = function () {
              ...
              var e = this.ss.begin(),
                ...
                r = e.pointer.high,
                n = t;
              n + 1 <= r ? this.ss.updateKeyByIterator(e, new s(t + 1, r)) : this.ss.eraseElementByPos(0);
              i("alloc():" + n);
              return n;
            };
              ...
              if (e < this.min || e > this.max) {
                ...
                if (r.equals(this.ss.end())) {
                  ...
                  if (r.equals(this.ss.begin())) {
                    ...
                    r.pre();
                    var h = r.pointer.low;
                    if (r.pointer.high + 1 === e) {
                      if (e + 1 === c) {
                        this.ss.eraseElementByIterator(r);
                        var f = r.pointer.high;
                        this.ss.updateKeyByIterator(r, new s(h, f));
                      } else {
                        this.ss.updateKeyByIterator(r, new s(h, e));
                      }
                    } else {
                      e + 1 === c ? (this.ss.eraseElementByIterator(r.next()), this.ss.insert(new s(e, l))) : this.ss.insert(t);
                    }
                  }
                }
                i("free():" + e);
          ...
          56: [function (e, t, r) {
            (function (e) {
              (function () {
                0 === e || !e.version || 0 === e.version.indexOf("v0.") || 0 === e.version.indexOf("v1.") && 0 !== e.version.indexOf("v1.8.") ? t.exports = {
          ...
          57: [function (e, t, r) {
            ...
            !function () {
              try {
                "function" == typeof setTimeout ? n = setTimeout : n = s;
              } catch (e) {
                n = s;
              }
              try {
                "function" == typeof clearTimeout ? i = clearTimeout : i = a;
              } catch (e) {
                i = a;
              }
            }();
          ...
          58: [function (e, t, n) {
              ...
              (function () {
                !function (r) {
                  ...
                  function b(e, t) {
                    ...
                    return n + m((e = e.replace(p, ".")).split("."), t).join(".");
                  }
                  function w(e) {
                  ...
                  function _(e) {
                    return m(e, function (e) {
                      var t = "";
                      e > 65535 && (t += g((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e);
                      return t + g(e);
                    }).join("");
                  }
                  function k(e, t) {
                  ...
                  function E(e, t, r) {
                    var n = 0;
                    for (r ? e = v(e / 700) : e = e >> 1, e += v(e / t); e > 455; n += l) e = v(e / 35);
                  ...
                  function P(e) {
                    ...
                    for ((r = e.lastIndexOf("-")) < 0 && (r = 0), n = 0; n < r; ++n) {
                      e.charCodeAt(n) >= 128 && y("not-basic");
                      d.push(e.charCodeAt(n));
                    }
                    for (r > 0 ? i = r + 1 : i = 0; i < g;) {
                      for (o = m, s = 1, a = l; i >= g && y("invalid-input"), (((p = e.charCodeAt(i++)) - 48 < 10 ? u = p - 22 : p - 65 < 26 ? u = p - 65 : p - 97 < 26 ? u = p - 97 : u = l) >= l || u > v((c - m) / s)) && y("overflow"), m += u * s, !(u < (a <= w ? h = 1 : a >= w + 26 ? h = 26 : h = a - w)); a += l) {
                        s > v(c / (f = l - h)) && y("overflow");
                        s *= f;
                      }
                      w = E(m - o, t = d.length + 1, 0 == o);
                      v(m / t) > c - b && y("overflow");
                      b += v(m / t);
                      m %= t;
                      d.splice(m++, 0, b);
                    }
                  ...
                  function I(e) {
                    var t,
                      ...
                      _,
                      S = [];
                    for (d = (e = w(e)).length, t = 128, r = 0, o = 72, s = 0; s < d; ++s) if ((p = e[s]) < 128) {
                      S.push(g(p));
                    }
                    for (n = i = S.length, i && S.push("-"); n < d;) {
                      for (a = c, s = 0; s < d; ++s) if ((p = e[s]) >= t && p < a) {
                        a = p;
                      }
                      for (a - t > v((c - r) / (m = n + 1)) && y("overflow"), r += (a - t) * m, t = a, s = 0; s < d; ++s) if ((p = e[s]) < t && ++r > c && y("overflow"), p == t) {
                        for (u = r, h = l; !(u < (h <= o ? f = 1 : h >= o + 26 ? f = 26 : f = h - o)); h += l) {
                          _ = u - f;
                          b = l - f;
                          S.push(g(k(f + _ % b, 0)));
                          u = v(_ / b);
            ...
            }).call(this, 0 !== r ? r : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
          }, {}],
          59: [function (e, t, r) {
            function n(e, t) {
              return Object.prototype.hasOwnProperty.call(e, t);
            ...
            t.exports = function (e, t, r, o) {
              ...
              for (var l = 0; l < c; ++l) {
                var h,
                  ...
                  v = e[l].replace(a, "%20"),
                  g = v.indexOf(r);
                g >= 0 ? (h = v.substr(0, g), f = v.substr(g + 1)) : (h = v, f = "");
          ...
          60: [function (e, t, r) {
            ...
            t.exports = function (e, t, r, a) {
              ...
              r = r || "=";
              null === e && (e = 0);
              return "object" === S(e) ? o(s(e), function (s) {
          ...
          62: [function (e, t, r) {
            ...
            i("ERR_INVALID_ARG_TYPE", function (e, t, r) {
              var n, i, s;
              "string" == typeof t && (i = "not ", t.substr(0, i.length) === i) ? (n = "must not be", t = t.replace(/^not /, "")) : n = "must be";
              if (function (e, t, r) {
                (0 === r || r > e.length) && (r = e.length);
                ...
                var a = function (e, t, r) {
                  "number" != typeof r && (r = 0);
                  return !(r + ".".length > e.length) && -1 !== e.indexOf(".", r);
                }(e) ? "property" : "argument";
            ...
            (function (r) {
              (function () {
                ...
                function c(e) {
                  ...
                  e && (!1 === e.readable && (this.readable = !1), !1 === e.writable && (this.writable = !1), !1 === e.allowHalfOpen && (this.allowHalfOpen = !1, this.once("end", l)));
                }
                function l() {
                ...
                Object.defineProperty(c.prototype, "destroyed", {
                  enumerable: !1,
                  get: function () {
                    return 0 !== this._readableState && 0 !== this._writableState && this._readableState.destroyed && this._writableState.destroyed;
                  },
                  set: function (e) {
                    if (0 !== this._readableState && 0 !== this._writableState) {
          ...
          65: [function (e, t, n) {
            (function (r, n) {
              (function () {
                    ...
                    (function (e, t) {
                      ...
                      if (!t.ended) {
                        if (t.decoder) {
                          ...
                          if (r && r.length) {
                            t.buffer.push(r);
                            t.objectMode ? t.length += 1 : t.length += r.length;
                          }
                        }
                        t.ended = !0;
                        t.sync ? O(e) : (t.needReadable = !1, t.emittedReadable || (t.emittedReadable = !0, C(e)));
                      }
                    })(e, a);
                  } else {
                    i || (s = function (e, t) {
                      var r, n;
                      n = t;
                      u.isBuffer(n) || n instanceof c || "string" == typeof t || 0 === t || e.objectMode || (r = new m("chunk", ["string", "Buffer", "Uint8Array"], t));
                      return r;
                    }(a, t));
                    if (s) {
                      k(e, s);
                    } else {
                      if (a.objectMode || t && t.length > 0) {
                        "string" == typeof t || a.objectMode || Object.getPrototypeOf(t) === u.prototype || (t = function (e) {
                          return u.from(e);
                        }(t));
                        if (n) {
                          a.endEmitted ? k(e, new _()) : x(e, a, t, !0);
                        } else {
                          if (a.ended) {
                            k(e, new b());
                          } else {
                            ...
                            a.reading = !1;
                            a.decoder && !r ? (t = a.decoder.write(t), a.objectMode || 0 !== t.length ? x(e, a, t, !1) : R(e, a)) : x(e, a, t, !1);
                          }
                        }
                      } else {
                        n || (a.reading = !1, R(e, a));
                ...
                function x(e, t, r, n) {
                  t.flowing && 0 === t.length && !t.sync ? (t.awaitDrain = 0, e.emit("data", r)) : (t.objectMode ? t.length += 1 : t.length += r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && O(e));
                  R(e, t);
                }
                Object.defineProperty(P.prototype, "destroyed", {
                  enumerable: !1,
                  get: function () {
                    return 0 !== this._readableState && this._readableState.destroyed;
                  },
                  set: function (e) {
                ...
                P.prototype.push = function (e, t) {
                  ...
                  n.objectMode ? r = !0 : "string" == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = u.from(e, t), t = ""), r = !0);
                ...
                function T(e, t) {
                  return e <= 0 || 0 === t.length && t.ended ? 0 : t.objectMode ? 1 : e != e ? t.flowing && t.length ? t.buffer.head.data.length : t.length : (e > t.highWaterMark && (t.highWaterMark = function (e) {
                    e >= A ? e = A : (e--, e |= e >>> 1, e |= e >>> 2, e |= e >>> 4, e |= e >>> 8, e |= e >>> 16, e++);
                    return e;
                ...
                function O(e) {
                  ...
                  t.needReadable = !1;
                  t.emittedReadable || (o("emitReadable", t.flowing), t.emittedReadable = !0, r.nextTick(C, e));
                }
                function C(e) {
                  var t = e._readableState;
                ...
                function D(e, t) {
                  return 0 === t.length ? null : (t.objectMode ? r = t.buffer.shift() : !e || e >= t.length ? (t.decoder ? r = t.buffer.join("") : 1 === t.buffer.length ? r = t.buffer.first() : r = t.buffer.concat(t.length), t.buffer.clear()) : r = t.buffer.consume(e, t.decoder), r);
                  var r;
                }
                function U(e) {
                  var t = e._readableState;
                ...
                function q(e, t) {
                  ...
                  if (!e.endEmitted && 0 === e.length && (e.endEmitted = !0, t.readable = !1, t.emit("end"), e.autoDestroy)) {
                ...
                P.prototype.read = function (e) {
                  ...
                  var n,
                    i = t.needReadable;
                  o("need readable", i);
                  (0 === t.length || t.length - e < t.highWaterMark) && o("length less than watermark", i = !0);
                  t.ended || t.reading ? o("reading or ended", i = !1) : i && (o("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, t.reading || (e = T(r, t)));
                  null === (e > 0 ? n = D(e, t) : n = null) ? (t.needReadable = t.length <= t.highWaterMark, e = 0) : (t.length -= e, t.awaitDrain = 0);
                  0 === t.length && (t.ended || (t.needReadable = !0), r !== e && t.ended && U(this));
                ...
                P.prototype.pipe = function (e, t) {
                  ...
                  i.pipesCount += 1;
                  o("pipe count=%d opts=%j", i.pipesCount, t);
                  ...
                  function h(t) {
                    ...
                    var r = e.write(t);
                    o("dest.write", r);
                    !1 === r && ((1 === i.pipesCount && i.pipes === e || i.pipesCount > 1 && -1 !== F(i.pipes, e)) && !l && (o("false write response, pause", i.awaitDrain), i.awaitDrain++), n.pause());
                  }
                  function f(t) {
                    o("onerror", t);
                    v();
                ...
                P.prototype.unpipe = function (e) {
                  ...
                  if (1 === t.pipesCount) {
                    e && e !== t.pipes || (e || (e = t.pipes), t.pipes = null, t.pipesCount = 0, t.flowing = !1, e && e.emit("unpipe", this, r));
                    return this;
                  }
                  if (!e) {
                    var n = t.pipes,
                  ...
                  var s = F(t.pipes, e);
                  -1 === s || (t.pipes.splice(s, 1), t.pipesCount -= 1, 1 === t.pipesCount && (t.pipes = t.pipes[0]), e.emit("unpipe", this, r));
                  return this;
                };
                P.prototype.on = function (e, t) {
                  var n = a.prototype.on.call(this, e, t),
                    i = this._readableState;
                  "data" === e ? (i.readableListening = this.listenerCount("readable") > 0, !1 !== i.flowing && this.resume()) : "readable" === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, o("on readable", i.length, i.reading), i.length ? O(this) : i.reading || r.nextTick(M, this)));
                  return n;
                };
                ...
                P.prototype.removeListener = function (e, t) {
                  ...
                  "readable" === e && r.nextTick(L, this);
                  return n;
                };
                P.prototype.removeAllListeners = function (e) {
                  var t = a.prototype.removeAllListeners.apply(this, arguments);
                  "readable" !== e && 0 !== e || r.nextTick(L, this);
                  return t;
                };
                P.prototype.resume = function () {
                  var e = this._readableState;
                  e.flowing || (o("resume"), e.flowing = !e.readableListening, function (e, t) {
                ...
                P.prototype.wrap = function (e) {
                  ...
                  }), e) if (0 === this[i] && "function" == typeof e[i]) {
                    this[i] = function (t) {
                      return function () {
                ...
                "function" == typeof Symbol && (P.prototype[Symbol.asyncIterator] = function () {
                  0 === f && (f = e("./internal/streams/async_iterator"));
                  return f(this);
                });
                ...
                "function" == typeof Symbol && (P.from = function (t, r) {
                  0 === p && (p = e("./internal/streams/from"));
                  return p(P, t, r);
                });
              }).call(this);
            }).call(this, e("_process"), 0 !== r ? r : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
          }, {
            "../errors": 62,
            "./_stream_duplex": 63,
              ...
              (function () {
                  ...
                  this.onwrite = function (e) {
                    !function (e, t) {
                      ...
                      if (t) {
                        !function (e, t, n, i, o) {
                          --t.pendingcb;
                          n ? (r.nextTick(o, i), r.nextTick(C, e, t), e._writableState.errorEmitted = !0, k(e, i)) : (o(i), e._writableState.errorEmitted = !0, k(e, i), C(e, t));
                        }(e, n, i, t, o);
                      } else {
                  ...
                  if (e._writev && r && r.next) {
                    ...
                    for (; r;) {
                      var c = r.chunk,
                        l = r.encoding,
                        h = r.callback;
                      I(e, t, !1, t.objectMode ? 1 : c.length, c, l, h);
                      r = r.next;
                ...
                P.prototype.write = function (e, t, n) {
                  ...
                  o.ending ? function (e, t) {
                    ...
                    var o;
                    null === n ? o = new b() : "string" == typeof n || t.objectMode || (o = new d("chunk", ["string", "Buffer"], n));
                    return !o || (k(e, o), r.nextTick(i, o), !1);
                ...
                Object.defineProperty(P.prototype, "destroyed", {
                  enumerable: !1,
                  get: function () {
                    return 0 !== this._writableState && this._writableState.destroyed;
                  },
                  set: function (e) {
                ...
                P.prototype.destroy = h.destroy;
                P.prototype._undestroy = h.undestroy;
                P.prototype._destroy = function (e, t) {
                  t(e);
                };
              }).call(this);
                ...
                t.exports = function (e) {
                  ...
                  o(e, function (e) {
                    if (e && "ERR_STREAM_PREMATURE_CLOSE" !== e.code) {
                      var t = n[a];
                      null !== t && (n[l] = null, n[s] = null, n[a] = null, t(e));
                      return n[u] = e;
                    }
                    var r = n[s];
                    null !== r && (n[l] = null, n[s] = null, n[a] = null, r(p(0, !0)));
                    n[c] = !0;
                  });
          ...
          69: [function (e, t, r) {
            ...
            t.exports = function () {
              ...
              (r = [{
                ...
                value: function (e, t) {
                  var r;
                  e < this.head.data.length ? (r = this.head.data.slice(0, e), this.head.data = this.head.data.slice(e)) : e === this.head.data.length ? r = this.shift() : t ? r = this._getString(e) : r = this._getBuffer(e);
                  return r;
                }
              }, {
                key: "first",
          ...
          71: [function (e, t, r) {
            ...
            t.exports = function e(t, r, o) {
              ...
              var s = r.readable || !1 !== r.readable && t.readable,
                ...
                d = function () {
                  var e;
                  return s && !h ? (t._readableState && t._readableState.ended || (e = new n()), o.call(t, e)) : a && !c ? (t._writableState && t._writableState.ended || (e = new n()), o.call(t, e)) : 0;
                },
                v = function () {
                  t.req.on("finish", l);
                };
              (function (e) {
                return e.setHeader && "function" == typeof e.abort;
              })(t) ? (t.on("complete", l), t.on("abort", d), t.req ? v() : t.on("request", v)) : a && !t._writableState && (t.on("end", u), t.on("close", u));
              t.on("end", f);
              t.on("finish", l);
                ...
                return function (t, r, i, o) {
                  ...
                  return function (e) {
                    if (!a && !u) {
                      ...
                      return function (e) {
                        return e.setHeader && "function" == typeof e.abort;
                      }(t) ? t.abort() : "function" == typeof t.destroy ? t.destroy() : o(e || new s("pipe"));
                    }
                  };
                }(t, o, i > 0, function (e) {
                  l || (l = e);
          ...
          77: [function (e, t, r) {
            ...
            s.alloc = function (e, t, r) {
              ...
              var n = i(e);
              0 !== t ? "string" == typeof r ? n.fill(t, r) : n.fill(t) : n.fill(0);
              return n;
            };
            s.allocUnsafe = function (e) {
              if ("number" != typeof e) {
          ...
          79: [function (e, t, r) {
            ...
            function a(e) {
              ...
              return 0 !== r ? r : this.lastNeed <= e.length ? (e.copy(this.lastChar, t, 0, this.lastNeed), this.lastChar.toString(this.encoding, 0, this.lastTotal)) : (e.copy(this.lastChar, t, 0, e.length), this.lastNeed -= e.length);
            }
            function u(e, t) {
              if ((e.length - t) % 2 == 0) {
          ...
          80: [function (e, t, r) {
            ...
            o.prototype.parse = function (e, t, r) {
              if (!i.isString(e)) {
                throw new TypeError("Parameter 'url' must be a string, not " + S(e));
              }
              var o = e.indexOf("?"),
                a = -1 !== o && o < e.indexOf("#") ? "?" : "#",
                c = e.split(a);
              ...
              if (!r && 1 === e.split("#").length) {
                ...
                if (w) {
                  ...
                  this.href = b;
                  this.pathname = w[1];
                  w[2] ? (this.search = w[2], t ? this.query = m.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t && (this.search = "", this.query = {});
                  return this;
                }
              }
              var _ = s.exec(b);
              ...
              if (!g[_] && (E || _ && !y[_])) {
                for (var P, I, x = -1, A = 0; A < f.length; A++) if (-1 !== (T = b.indexOf(f[A])) && (-1 === x || T < x)) {
                  x = T;
                }
                for (-1 !== (-1 === x ? I = b.lastIndexOf("@") : I = b.lastIndexOf("@", x)) && (P = b.slice(0, I), b = b.slice(I + 1), this.auth = decodeURIComponent(P)), x = -1, A = 0; A < h.length; A++) {
                  var T;
                  if (-1 !== (T = b.indexOf(h[A])) && (-1 === x || T < x)) {
                    x = T;
                  }
                }
                -1 === x && (x = b.length);
              ...
              var W = b.indexOf("#");
              if (-1 !== W) {
                this.hash = b.substr(W);
                b = b.slice(0, W);
              }
              var K = b.indexOf("?");
              -1 !== K ? (this.search = b.substr(K), this.query = b.substr(K + 1), t && (this.query = m.parse(this.query)), b = b.slice(0, K)) : t && (this.search = "", this.query = {});
              b && (this.pathname = b);
            ...
            o.prototype.format = function () {
              ...
              t && ":" !== t.substr(-1) && (t += ":");
              this.slashes || (!t || y[t]) && !1 !== o ? (o = "//" + (o || ""), r && "/" !== r.charAt(0) && (r = "/" + r)) : o || (o = "");
              n && "#" !== n.charAt(0) && (n = "#" + n);
              a && "?" !== a.charAt(0) && (a = "?" + a);
              return t + o + (r = r.replace(/[?#]/g, function (e) {
            ...
            o.prototype.resolveObject = function (e) {
              ...
              if (e.slashes && !e.protocol) {
                ...
                y[r.protocol] && r.hostname && !r.pathname && (r.path = r.pathname = "/");
                r.href = r.format();
                return r;
              }
              ...
              S && (r.hostname = "", r.port = null, r.host && ("" === E[0] ? E[0] = r.host : E.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), _ = _ && ("" === d[0] || "" === E[0]));
              if (w) {
                e.host || "" === e.host ? r.host = e.host : r.host = r.host;
                e.hostname || "" === e.hostname ? r.hostname = e.hostname : r.hostname = r.hostname;
                r.search = e.search;
                r.query = e.query;
                E = d;
              } else {
                if (d.length) {
                  ...
                  if (!i.isNullOrUndefined(e.search)) {
                    S && (r.hostname = r.host = E.shift(), (T = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = T.shift(), r.host = r.hostname = T.shift()));
                    r.search = e.search;
                    r.query = e.query;
              ...
              S && (O ? r.hostname = r.host = "" : E.length ? r.hostname = r.host = E.shift() : r.hostname = r.host = "", (T = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = T.shift(), r.host = r.hostname = T.shift()));
            ...
            t.exports = function e(t, r) {
              ...
              function n() {
                ...
                var n = t.apply(this, e),
                  i = e[e.length - 1];
                "function" == typeof n && n !== i && Object.keys(i).forEach(function (e) {
                  n[e] = i[e];
                });
                return n;
              }
          ...
          85: [function (e, t, r) {
            ...
            n.prototype.splice = function (e, t) {
              ...
              for (null === n && (n = this.tail), n !== this.head && n !== this.tail && (n = n.prev), r = 0; r < (arguments.length <= 2 ? 0 : arguments.length - 2); r++) n = i(this, n, r + 2 < 2 || arguments.length <= r + 2 ? 0 : arguments[r + 2]);
              return o;
            };
      ...
      "object" === S(t) && 0 !== e ? e.exports = s() : (i = [], 0 === ("function" == typeof (n = s) ? o = n.apply(t, i) : o = n) || (e.exports = o));
    ...
    (function (e) {
      ...
      function o() {
        ...
        function E(e, t) {
          ...
          if (0 === n) {
            t.delegate = null;
            "throw" === r && e.iterator.return && (t.method = "return", t.arg = 0, E(e, t), "throw" === t.method) || "return" !== r && (t.method = "throw", t.arg = new TypeError("The iterator does not provide a '" + r + "' method"));
            return f;
          }
          ...
          var o = i.arg;
          return o ? o.done ? (t[e.resultName] = o.value, t.next = e.nextLoc, "return" !== t.method && (t.method = "next", t.arg = 0), t.delegate = null, f) : o : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, f);
        }
        function S(e) {
          var t = {
            tryLoc: e[0]
        ...
        e.mark = e => (Object.setPrototypeOf ? Object.setPrototypeOf(e, v) : (e.__proto__ = v, c(e, u, "GeneratorFunction")), e.prototype = Object.create(b), e);
        e.awrap = e => ({
          __await: e
        });
        w(_.prototype);
        ...
        I.prototype = {
          ...
          abrupt: function (e, t) {
            ...
            s.type = e;
            s.arg = t;
            return o ? (this.method = "next", this.next = o.finallyLoc, f) : this.complete(s);
          },
          complete: function (e, t) {
            if ("throw" === e.type) {
              throw e.arg;
      ...
      function s(e) {
        return ("function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? s = e => typeof e : s = e => e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e)(e);
      }
      ...
      var d,
        v = "wss://mu.y.qq.com/ws/handshake",
        g = {
          keepalive: 45,
          protocolVersion: 5,
          properties: {
      ...
      function _(e, t) {
        return new Promise(e => {
          ...
          r.open("POST", "https://u6.y.qq.com/cgi-bin/musics.fcg", !0);
          r.timeout = 2e4;
          r.onreadystatechange = () => {
            var t, n;
            if (r && 4 === r.readyState && (0 !== r.status || r.responseURL && 0 === r.responseURL.indexOf("file:"))) {
              r.status >= 200 && r.status <= 300 || 304 === r.status || 0 === r.status || (t = -r.status);
              n = r.response;
              var i = JSON.parse(n);
              e(t ? {
                err: n
        ...
        return (E = u(o().mark(function e(t) {
          ...
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              ...
              case 7:
                {
                  if (0 !== (null == a || null === (r = a.req_0) || 0 === r ? 0 : r.code)) {
                    e.next = 11;
                    break;
                  }
                  c = a.req_0.data;
              ...
              case 11:
                {
                  return e.abrupt("return", Promise.reject((null == a || null === (n = a.req_0) || 0 === n ? 0 : n.Msg) || "Get Ws Report Config Error:".concat(null == a || null === (i = a.req_0) || 0 === i ? 0 : i.code)));
                }
              case 12:
                {}
              case "end":
        ...
        return (P = u(o().mark(function e(t) {
          ...
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              ...
              case 11:
                {
                  return e.abrupt("return", Promise.reject((null == a || null === (n = a.req_0) || 0 === n ? 0 : n.msgs) || "Ws Timing Report Error:".concat(null == a || null === (i = a.req_0) || 0 === i ? 0 : i.code)));
                }
              case 12:
                {}
              case "end":
        ...
        return (x = u(o().mark(function e(t) {
          ...
          return o().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              ...
              case 9:
                {
                  return e.abrupt("return", Promise.reject((null == a || null === (n = a.req_0) || 0 === n ? 0 : n.msg) || "Ws Error Report Error:".concat(null == a || null === (i = a.req_0) || 0 === i ? 0 : i.code)));
                }
              case 10:
                {}
              case "end":
      ...
      (e => {
        ...
        e[e.connack = 2] = "connack";
        e[e.publish = 3] = "publish";
        e[e.puback = 4] = "puback";
        e[e.pubrec = 5] = "pubrec";
        e[e.pubrel = 6] = "pubrel";
        e[e.pubcomp = 7] = "pubcomp";
        e[e.subscribe = 8] = "subscribe";
        e[e.suback = 9] = "suback";
        e[e.unsubscribe = 10] = "unsubscribe";
        e[e.unsuback = 11] = "unsuback";
        e[e.pingreq = 12] = "pingreq";
        e[e.pingresp = 13] = "pingresp";
        e[e.disconnect = 14] = "disconnect";
      })(b || (b = {}));
      var C = new (function () {
        function e() {
          c(this, e);
          ...
          f(this, "userId", "");
          f(this, "needSamplingReport", !1);
          f(this, "timingReportTimer", 0);
          f(this, "errorReportTimer", 0);
          f(this, "timeDiff", 0);
        }
        var t, r, n, s, a, l;
        h(e, [{
          key: "init",
          value: (l = u(o().mark(function e(t) {
            return o().wrap(function (e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  {
                    e.next = 2;
                    return this.getWsConfigs();
                  }
                case 2:
                  {
                    this.initConfigs();
                    this.getReportBuffer();
                  }
                case 4:
                  {}
                case "end":
          ...
          key: "initTimeCalibration",
          value: function (e) {
            var t = e.subscribeStart,
              r = e.subscribeEnd,
              n = e.serverTime,
              i = Date.now();
            if (t && r && n) {
              ...
              this.timeDiff = i - (n + o);
              this.logger("~~ QmSocket:: Time calibrate timeDiff:", this.timeDiff);
            }
          }
        }, {
          key: "report",
          value: (a = u(o().mark(function e(t, r) {
                ...
                case 0:
                  {
                    ...
                    c = {
                      topic: i,
                      userID: this.userId,
                      publishTime: parseInt(null == s || null === (a = s.userProperties) || 0 === a ? 0 : a.publishTime, 10),
                      brokerPublishTime: parseInt(null == s || null === (u = s.userProperties) || 0 === u ? 0 : u.brokerPublishTime, 10),
                      clientRecvTime: Date.now() - this.timeDiff,
                      clientSendTime: Date.now() - this.timeDiff
                    };
                    e.prev = 3;
                    this.logger("~~ QmSocket:: sampling report:", c);
                    e.next = 7;
                    return I(c);
                  }
                case 7:
                  {
                    l = e.sent;
                    this.reportConfig.elapsePercent = l;
                    this.needSamplingReport = O(this.userId) < 100 * l;
                    e.next = 15;
                    break;
                  }
                case 12:
                ...
                case 15:
                  {
                    ...
                    p = {
                      channelID: h || "",
                      clientID: f || "",
                      msgID: null == s || null === (n = s.userProperties) || 0 === n ? 0 : n.msgID,
                      time: Date.now() - this.timeDiff
                    };
                    this.reportBuffer.push(p);
                    localStorage.setItem("wsReport", JSON.stringify(this.reportBuffer));
          ...
          value: function (e) {
            ...
            this.logger("~~ QmSocket:: ack report:", t);
            (function (e) {
              _(0, [{
                module: "music.goms.logic",
                method: "ack",
                param: e
              }]);
            })(t);
          ...
          key: "reportError",
          value: (s = u(o().mark(function e(t, r) {
                ...
                case 0:
                  {
                    ...
                    f = {
                      ...
                      userID: this.userId,
                      channelID: h || "",
                      msgID: "".concat(null == u || null === (n = u.userProperties) || 0 === n ? 0 : n.msgID),
                      code: c || -1,
                      packetType: +b[l]
                    };
                    this.errorBuffer.push(f);
                    0 === (null === (i = this.reportConfig) || 0 === i ? 0 : i.failInterval) && this.doErrorReport();
                  }
                case 5:
                  {}
                case "end":
            ...
            return o().wrap(function (e) {
              for (;;) switch (e.prev = e.next) {
                ...
                case 2:
                  {
                    e.prev = 2;
                    this.logger("~~ QmSocket:: error report:", this.errorBuffer);
                    e.next = 6;
                    return A({
                      items: this.errorBuffer
                    });
                  }
                case 6:
                  {
                    t = e.sent;
                    this.reportConfig.failInterval = t;
                    this.errorBuffer = [];
                    e.next = 14;
                    break;
                  }
            ...
            return o().wrap(function (e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  {
                    e.prev = 0;
                    this.logger("~~ QmSocket:: get WS config, uin: ".concat(""));
                    e.next = 5;
                    return k("");
                  }
                case 5:
          ...
          value: function () {
            this.userId = "";
            var e = O(this.userId),
              t = this.reportConfig.elapsePercent;
            this.needSamplingReport = e < 100 * t;
            this.setTimeIntervals();
            this.setErrorTimeIntervals();
          }
        }, {
          key: "getReportBuffer",
          value: function () {
            try {
              ...
              if (e) {
                try {
                  this.reportBuffer = JSON.parse(e);
                  localStorage.removeItem("wsReport");
                } catch (e) {}
              }
            } catch (e) {}
          }
          ...
          value: function () {
            var e = this,
              t = this.reportConfig.arriveInterval;
            if (0 === t) {
              this.doReport();
            } else {
              if (t > 0) {
                if (this.timingReportTimer) {
                  return;
                }
                this.timingReportTimer = window.setTimeout(() => {
                  e.logger("~~ QmSocket:: reportTimer");
                  e.doReport();
                  e.timingReportTimer = 0;
                }, 1e3 * t);
              }
            }
          }
        }, {
          key: "setErrorTimeIntervals",
          value: function () {
            var e = this,
              t = this.reportConfig.failInterval;
            if (0 === t) {
              this.doErrorReport();
            } else {
              if (t > 0) {
                ...
                this.errorReportTimer = window.setTimeout(() => {
                  e.logger("~~ QmSocket:: errReportTimer");
                  e.doErrorReport();
                  e.errorReportTimer = 0;
                }, 1e3 * t);
              }
            }
          }
                ...
                case 2:
                  {
                    ...
                    e.prev = 3;
                    this.logger("~~ QmSocket:: timing report:", t);
                    e.next = 7;
                    return S(t);
                  }
                case 7:
      ...
      var ee,
        ...
        oe = "ios" === X,
        se = Z("login_type") || "0",
        ae = (ee = D.match(/\bNetType\/(\w+)/i)) ? ee[1] : "unknown",
        ue = "getDeviceInfo",
        ce = "getGuid",
        le = {
          _appid: "qqmusic",
        ...
        fe = function (e, t, r) {
                ...
                if (Q && window.M) {
                  var t = function (e) {
                    return new Promise(t => {
                      ...
                      r = e;
                      n = r => {
                        e === ue ? (le._mobile_factory = r.modelVersion, le._mobile_type = r.modelVersion, le._os_version = r.systemVersion) : e === ce ? (le._deviceid = r.imei, le._mnc = r.isp) : le._network_type = V(r.type);
                        t();
                      };
          ...
          n = () => {
            ne && clearTimeout(ne);
            -1 != r ? ne = M(i, r >= 0 ? r : 500) : i();
          };
          q ? n() : F.push(n);
        };
      (e => {
        e[e.INIT = 1] = "INIT";
        e[e.LONGPOLLING_INIT = 2] = "LONGPOLLING_INIT";
        e[e.MESSAGE_ERROR = 3] = "MESSAGE_ERROR";
        e[e.PACKET = 4] = "PACKET";
        e[e.ERROR = 5] = "ERROR";
      })(ie || (ie = {}));
      var pe,
        ...
        ge = function (e) {
          var t = i({
            cmd: 21,
            int20: e
          }, arguments.length > 1 && 0 !== arguments[1] ? arguments[1] : {});
          fe("webcomm", t);
        },
        ye = {
          clientId: "",
          getClientId: (pe = u(o().mark(function e(t) {
            return o().wrap(function (e) {
              for (;;) switch (e.prev = e.next) {
                case 0:
                  {
                ...
                case 2:
                  {
                    this.clientId = "".concat(Date.now()).concat(Math.floor(1e4 * Math.random()));
                    return e.abrupt("return", this.clientId);
                  }
                case 4:
                  {}
          ...
          mergeDeep: function (e) {
            ...
            if (this.isObject(e) && this.isObject(i)) {
              for (var o in i) this.isObject(i[o]) ? (e[o] || Object.assign(e, f({}, o, {})), this.mergeDeep(e[o], i[o])) : Object.assign(e, f({}, o, i[o]));
            }
      ...
      (e => {
        ...
        e[e.LONGPOLLING = 1] = "LONGPOLLING";
      })(ve || (ve = {}));
      var be = function () {
          for (var e, t = arguments.length, r = new Array(t), n = 0; n < t; n++) r[n] = arguments[n];
          if ("1" === ye.getParam("isDev")) {
            (e = console).warn.apply(e, ["----- QmSocketDev::"].concat(r));
          }
        },
        we = function () {
          function t(e) {
            ...
            c(this, t);
            f(this, "config", 0);
            f(this, "logger", function () {
              var e;
              if ("1" === ye.getParam("debug")) {
                (e = console).warn.apply(e, arguments);
              }
            });
            f(this, "topics", []);
            f(this, "socket", 0);
            f(this, "userProperties", 0);
            f(this, "authenticationMethod", "");
            f(this, "wsUrl", v);
            f(this, "clientId", "");
            f(this, "inOrder", !1);
            f(this, "uin", 0);
            f(this, "onMsgCallback", 0);
            f(this, "onConnectCallback", 0);
            f(this, "onSubscribeCallback", 0);
            f(this, "onErrorCallback", 0);
            f(this, "timeCalibrationConfig", 0);
            f(this, "longpollingXhrMap", {});
            f(this, "largestMsgIdMap", {});
            f(this, "wsProperties", {});
            f(this, "msgReportMap", {});
            f(this, "handleMessage", (e, t, n, i) => {
              var o, s, a;
              r.logger("~~ QmSocket:: ".concat(i === ve.LONGPOLLING ? "【LongPolling】" : "", "HandleMessage:"), e, t, n);
              var u,
                c,
                l,
                h = +((null == n || null === (o = n.properties) || 0 === o || null === (s = o.userProperties) || 0 === s ? 0 : s.msgID) || 0);
              null !== (a = r.msgReportMap) && 0 !== a && a[h] ? r.msgReportMap[h][i === ve.LONGPOLLING ? "lp" : "ws"] = !0 : r.msgReportMap[h] = {
                ws: i === ve.WEBSOCKET,
                lp: i === ve.LONGPOLLING
              };
              i === ve.LONGPOLLING && setTimeout(() => {
                ...
                ge(ie.MESSAGE_ERROR, n);
                delete r.msgReportMap[h];
                r.logger("【LongPolling】Report:", n);
              }, 1e3);
              r.largestMsgIdMap[e] !== h ? r.inOrder ? null === (u = r.largestMsgIdMap) || 0 === u || !u[n.topic] || r.largestMsgIdMap[n.topic] <= h ? (r.largestMsgIdMap[n.topic] = h, r.logger("~~ QmSocket:: ".concat(i === ve.LONGPOLLING ? "【LongPolling】" : "", "InOrder MsgCallback(topic/payload/packet):"), e, t, n), null === (c = r.onMsgCallback) || 0 === c || c.call(r, e, t, n)) : r.logger("~~ QmSocket:: ".concat(i === ve.LONGPOLLING ? "【LongPolling】" : "", "HandleMessage: Discard message packet:"), n, " payload:", t) : (r.largestMsgIdMap[n.topic] = h, r.logger("~~ QmSocket:: ".concat(i === ve.LONGPOLLING ? "【LongPolling】" : "", "NotInOrder MsgCallback(topic/payload/packet):"), e, t, n), null === (l = r.onMsgCallback) || 0 === l || l.call(r, e, t, n)) : r.logger("~~ QmSocket:: ".concat(i === ve.LONGPOLLING ? "【LongPolling】" : "", "HandleMessage: MsgId already existed, return"));
            });
            this.config = e;
            var n = e.topics,
              i = 0 === n ? [] : n,
              ...
              y = 0 !== g && g;
            this.topics = i;
            y ? this.wsUrl = "wss://test.y.qq.com/ws/handshake" : this.wsUrl = v;
            this.clientId = "";
            this.userProperties = u;
            this.authenticationMethod = h || "pass";
            this.inOrder = d;
            this.uin = s;
            C.init(e);
            this.init();
          ...
          h(t, [{
            ...
            value: (n = u(o().mark(function e() {
              ...
              return o().wrap(function (e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    {
                      if (c.length > 0 && 0 !== c[0] ? n = c[0] : n = this.wsUrl, this.clientId) {
                        e.next = 5;
                        break;
                      }
                      e.next = 4;
                      return ye.getClientId(this.config);
                    }
                  case 4:
                    {
                  ...
                  case 5:
                    {
                      s = Object.assign({
                        userID: this.uin || this.clientId
                      }, null === (t = g.properties) || 0 === t ? 0 : t.userProperties, this.userProperties);
                      a = i(i({}, g), {}, {
                        properties: i(i({}, g.properties), {}, {
                          authenticationData: "",
                          authenticationMethod: this.authenticationMethod || (null === (r = g.properties) || 0 === r ? 0 : r.authenticationMethod),
                          userProperties: s
                        }),
                        clientId: this.clientId
                      });
                      this.wsProperties.clientId = a.clientId;
                      this.largestMsgIdMap = {};
                      this.socket = me(n, a);
                      this.logger("~~ QmSocket:: topic subscribe: ".concat(JSON.stringify(this.topics)));
                      this.timeCalibrationConfig = {
                        subscribeStart: Date.now()
                      };
                      this.topics.forEach(e => {
                        var t,
                          r = i(i({}, y), {}, {
                            properties: i(i({}, y.properties), {}, {
                              userProperties: i(i({}, null === (t = y.properties) || 0 === t ? 0 : t.userProperties), {}, {
                                pubsub: e.pubType
                              })
                            })
                          });
                        u.socket.subscribe(e.topic, r);
                        e.subscribed = !0;
                      });
                      this.bindEvent();
                    }
            ...
            value: function () {
              ...
              this.socket.on("connect", t => {
                var r, n, i, o, s;
                e.wsProperties.channelID = (null === (r = t.properties) || 0 === r || null === (n = r.userProperties) || 0 === n ? 0 : n.channelID) || "";
                e.wsProperties.server = (null === (i = t.properties) || 0 === i || null === (o = i.userProperties) || 0 === o ? 0 : o.server) || "";
                e.logger("~~ QmSocket:: WS connected", "Property: ".concat(JSON.stringify(e.wsProperties)));
                null === (s = e.onConnectCallback) || 0 === s || s.call(e, t);
              });
              this.socket.on("error", (t, r) => {
                var n;
                e.logger("~~ QmSocket:: WS error", "Property: ".concat(JSON.stringify(e.wsProperties)), "Packet: ", r);
                e.errFunc(t, r);
                null === (n = e.onErrorCallback) || 0 === n || n.call(e, t);
              });
              ...
              this.socket.on("message", (t, r, n) => {
                ...
                var s = n.properties;
                if ((null == s || null === (i = s.userProperties) || 0 === i ? 0 : i.QoS) === m.QoS1) {
                  var a,
                    u,
                    c,
                    l = {
                      msgID: "".concat(null == s || null === (a = s.userProperties) || 0 === a ? 0 : a.msgID),
                      publishTime: parseInt(null == s || null === (u = s.userProperties) || 0 === u ? 0 : u.publishTime, 10),
                      brokerPublishTime: parseInt(null == s || null === (c = s.userProperties) || 0 === c ? 0 : c.brokerPublishTime, 10),
                ...
                try {
                  h = JSON.parse(o);
                  e.handleMessage(t, h, n, ve.WEBSOCKET);
                } catch (r) {
              ...
              this.socket.on("packetreceive", t => {
                var r, n, i, o;
                e.logger("~~ QmSocket:: PacketReceive:", t);
                "suback" === t.cmd && (null === (r = e.onSubscribeCallback) || 0 === r || r.call(e, t), null !== (n = e.timeCalibrationConfig) && 0 !== n && n.subscribeEnd || (e.timeCalibrationConfig || (e.timeCalibrationConfig = {}), e.timeCalibrationConfig.subscribeEnd = Date.now(), e.timeCalibrationConfig.serverTime = +((null == t || null === (i = t.properties) || 0 === i || null === (o = i.userProperties) || 0 === o ? 0 : o.timestamp) || 0), C.initTimeCalibration(e.timeCalibrationConfig)));
              });
            }
          }, {
            key: "errFunc",
            value: (r = u(o().mark(function e(t, r) {
              var n, i, s;
              return o().wrap(function (e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
                    {
                      if (null == r ? n = 0 : n = r.reasonCode, !Object.keys(w).includes("".concat(n))) {
                        e.next = 8;
                        break;
                      }
                      e.next = 4;
                  ...
                  case 4:
                    {
                      (null == r || null === (i = r.properties) || 0 === i ? s = 0 : s = i.serverReference) ? this.init("".concat(this.wsUrl, "/").concat(s)) : this.init();
                      e.next = 9;
                      break;
                    }
                  case 8:
            ...
            value: function (e) {
              ...
              e.forEach(e => {
                var n,
                  o = t.topics.find(t => t.topic === e.topic);
                if (o && o.subscribed) {
                  r.push(e);
                } else {
                  var s = i(i({}, y), {}, {
                    properties: i(i({}, y.properties), {}, {
                      userProperties: i(i({}, null === (n = y.properties) || 0 === n ? 0 : n.userProperties), {}, {
                        pubsub: e.pubType
                      })
                    })
                  });
                  t.socket.subscribe(e.topic, s);
                  o ? o.subscribed = !0 : t.topics.push(i(i({}, e), {}, {
                    subscribed: !0
                  }));
                }
              });
            ...
            value: function () {
              var e = this,
                t = arguments.length > 0 && 0 !== arguments[0] && arguments[0],
                r = function () {
                  e.logger("Close: Handle topics: ".concat(JSON.stringify(e.topics.map(e => e.topic))));
                  e.topics.forEach(t => {
                    e.stopLongPolling(t.topic);
                    t.subscribed = !1;
                  });
                };
              return new Promise(n => {
                t ? e.socket.end(!0, () => {
                  e.logger("~~ QmSocket:: WS force close");
                  r();
                  n(!0);
                }) : e.socket.end(!1, () => {
                  e.logger("~~ QmSocket:: WS close");
                  r();
                  n(!0);
                });
              });
            ...
            value: function (e, t, r) {
              ...
              i.open("POST", e.url, !0);
              i.timeout = e.timeout;
              i.setRequestHeader("x-goms-serial", "json");
              i.withCredentials = !0;
              i.responseType = "json";
              i.onload = () => {
              ...
              i.onerror = () => {
                n.logger("~~ QmSocket:: 【LongPolling】LongPolling: XHR Request error...");
                null == r || r(de.ERROR);
              };
              i.ontimeout = () => {
                n.logger("~~ QmSocket:: 【LongPolling】LongPolling: XHR Request timeout...");
                null == r || r(de.TIMEOUT);
              };
              i.onabort = () => {
                n.logger("~~ QmSocket:: 【LongPolling】LongPolling: XHR Request aborted...");
                null == r || r(de.ABORT);
              };
              var o = t,
                s = JSON.stringify(o);
            ...
            value: function (t) {
              var r,
                n = this;
              if (this.topics.some(e => e.topic === t && e.subscribed)) {
                if (null !== (r = this.longpollingXhrMap) && 0 !== r && r[t]) {
                  this.logger("~~ QmSocket:: 【LongPolling】StartLongPolling: 已存在".concat(t, "的长轮询链接，无需重复创建"));
                } else {
                  var i = 0;
                  !function r() {
                    var o,
                      s = arguments.length > 0 && 0 !== arguments[0] ? arguments[0] : de.SUCCESS,
                      a = arguments.length > 1 ? arguments[1] : 0;
                    n.logger("~~ QmSocket:: 【LongPolling】StartLongPolling SendReq(topic/status/res)", t, s, a);
                    if (null != a && a.packets && s === de.SUCCESS) {
                      var u = a.packets;
                      (0 === u ? [] : u).forEach(r => {
                        var i = r.payload,
                          o = 0 === i ? "" : i,
                    ...
                    var c = null === (o = n.topics) || 0 === o ? 0 : o.find(e => e.topic === t);
                    be("【LongPolling】SendReq(findTopic):", c);
                    if (null != c && c.subscribed) {
                      if ([de.ABORT, de.ERROR].includes(s) || 0 !== (null == a ? 0 : a.code) && 0 !== (null == a ? 0 : a.code)) {
                        n.logger("~~ QmSocket:: 【LongPolling】StartLongPolling SendReq(topic/status/errCount)", t, s, i);
                        if (i >= 5) {
                          return n.stopLongPolling(t);
                        }
                        i++;
                      }
                ...
                this.logger("~~ QmSocket:: 【LongPolling】StartLongPolling: QmSocket未订阅topic: ".concat(t, ", 长轮询建立失败"));
              }
            }
          }, {
            key: "stopLongPolling",
            value: function (e) {
              var t, r;
              null !== (t = this.longpollingXhrMap) && 0 !== t && t[e] ? (null === (r = this.longpollingXhrMap[e]) || 0 === r || r.abort(), this.longpollingXhrMap[e] = null) : this.logger("~~ QmSocket:: 【LongPolling】StopLongPolling: QmSocket未订阅topic: ".concat(e, ", 无可关闭的长轮询"));
            }
          }, {
            key: "getSocket",
            value: function () {
    ...
    (function (e) {
      ...
      */
      ...
      function a(e, t) {
        ...
        u.TYPED_ARRAY_SUPPORT ? (e = new Uint8Array(t)).__proto__ = u.prototype : (null === e && (e = new u(t)), e.length = t);
        return e;
      }
      function u(e, t, r) {
      ...
      function c(e, t, r, n) {
        ...
        return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? function (e, t, r, n) {
          ...
          0 === r && 0 === n ? t = new Uint8Array(t) : 0 === n ? t = new Uint8Array(t, r) : t = new Uint8Array(t, r, n);
      ...
      function y(e, t, r, n, i) {
        ...
        if ("number" == typeof t) {
          t &= 255;
          return u.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : m(e, [t], r, n, i);
        }
        throw new TypeError("val must be string, number or Buffer");
      }
      ...
      0 !== e.TYPED_ARRAY_SUPPORT ? u.TYPED_ARRAY_SUPPORT = e.TYPED_ARRAY_SUPPORT : u.TYPED_ARRAY_SUPPORT = function () {
        try {
          var e = new Uint8Array(1);
          e.__proto__ = {
            __proto__: Uint8Array.prototype,
      ...
      u.alloc = function (e, t, r) {
        return function (e, t, r, n) {
          l(t);
          return t <= 0 ? a(e, t) : 0 !== r ? "string" == typeof n ? a(e, t).fill(r, n) : a(e, t).fill(r) : a(e, t);
        }(null, e, t, r);
      };
      ...
      u.prototype.slice = function (e, t) {
        ...
        (0 === t ? t = n : t = ~~t) < 0 ? (t += n) < 0 && (t = 0) : t > n && (t = n);
        t < e && (t = e);
        if (u.TYPED_ARRAY_SUPPORT) {
      ...
      u.prototype.writeUInt16LE = function (e, t, r) {
        ...
        u.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0);
        return t + 2;
      };
      u.prototype.writeUInt16BE = function (e, t, r) {
        ...
        t |= 0;
        r || R(this, e, t, 2, 65535, 0);
        u.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1);
        return t + 2;
      };
      u.prototype.writeUInt32LE = function (e, t, r) {
        ...
        u.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : L(this, e, t, !0);
        return t + 4;
      };
      u.prototype.writeUInt32BE = function (e, t, r) {
        ...
        t |= 0;
        r || R(this, e, t, 4, 4294967295, 0);
        u.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : L(this, e, t, !1);
        return t + 4;
      };
      ...
      u.prototype.writeInt32LE = function (e, t, r) {
        ...
        u.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : L(this, e, t, !0);
        return t + 4;
      };
      ...
      u.prototype.copy = function (e, t, r, n) {
        ...
        if (this === e && r < t && t < n) {
          ...
          if (o < 1e3 || !u.TYPED_ARRAY_SUPPORT) {
  ...
  "51253eb34": function (e, t, r) {
    ...
    function l() {
      ...
      function x(t, r) {
        ...
        if (i === e) {
          r.delegate = null;
          "throw" === n && t.iterator.return && (r.method = "return", r.arg = e, x(t, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method"));
          return g;
        }
      ...
      t.mark = function (e) {
        Object.setPrototypeOf ? Object.setPrototypeOf(e, b) : (e.__proto__ = b, c(e, u, "GeneratorFunction"));
      ...
      O.prototype = {
        ...
        abrupt: function (e, t) {
          ...
          s.type = e;
          s.arg = t;
          return o ? (this.method = "next", this.next = o.finallyLoc, g) : this.complete(s);
        },
        complete: function (e, t) {
          if ("throw" === e.type) {
            throw e.arg;
    ...
    t.a = function (e) {
      var t = e.resData,
        ...
        N = Object(i.useMemo)(function () {
          if (null != r && r.webConf) {
            try {
              var e = JSON.parse(r.webConf),
                t = e.qrcodeTitle,
                n = e.qrcodeSubTitle,
                i = e.qrcodeDesc,
                o = e.scanSuccessTitle,
                s = e.scanSuccessSubTitle,
                a = e.scanSuccessDesc,
                u = e.scanFailedTitle,
                c = e.scanFailedSubTitle,
                l = e.scanFailedDesc,
                h = e.loginFailedTitle,
                f = e.loginFailedSubTitle,
                p = e.loginFailedDesc,
                d = e.qrcodeExpiredTitle,
                v = e.qrcodeExpiredSubTitle,
                g = e.qrcodeExpiredDesc,
                y = e.noQrcodeTitle,
                m = e.noQrcodeSubTitle,
                b = e.noQrcodeDesc;
              return w ? E ? {
                title: d,
                subtitle: v,
                ...
                case 0:
                  {
                    ...
                    window.console.log("qmSocket", o);
                    null == o || o.onMessage(function (e, t, r) {
                      var n, i;
                      window.console.log("onMessage", e, r, t);
                      var o = null == r || null == (n = r.properties) || null == (n = n.userProperties) ? 0 : n.type,
                        s = null == r || null == (i = r.properties) || null == (i = i.userProperties) ? 0 : i.msgID;
                      null == c.l || Object(c.l)({
                      ...
                      if ("scanned" === o) {
                        U(t.expiresIn);
                        (null == t ? 0 : t.appName) && x(t.appName);
                        null == t ? L.current = 0 : L.current = t.appType;
                        O(!1);
                      } else {
                        if ("cookies" === o) {
                          var a;
                          if (null != t && t.cookies && null != t && t.commConf && Object.keys(t.cookies).length >= 2) {
                            if ("20" === f || "6" === f || "19" === f) {
                              null == (a = window) || null == (a = a.top) || a.postMessage(JSON.stringify({
                                code: "qqmusic",
                                cookies: t.cookies
                              }), location.origin);
                              null == c.l || Object(c.l)({
                              ...
                              if ("24" === f) {
                                ...
                                "1" === f || "11" === f || "46" === f || "18" === f ? u.client.open("other", "scanLoginResult", {
                                  cookies: t.cookies,
                                  appType: L.current
                          ...
                          "canceled" === o ? (O(!0), x("")) : "loginFailed" === o && B(!0);
                        }
                      }
                    });
                  }
                ...
                case 2:
                  {
                    ...
                    O(!1);
                    B(!1);
                    "1" !== f && "11" !== f && "46" !== f || null == c.k || Object(c.k)({
                      element_id: "1021059"
                    });
                  }
                case 13:
      ...
      Object(i.useEffect)(function () {
        "1" !== f && "11" !== f && "46" !== f || (u.client.open("ui", "hideMiniPlayer", {}), null == c.l || Object(c.l)({
          element_id: "5019754"
        }));
      }, [f]);
      var q, F;
      "1" === f || "11" === f || "46" === f || "18" === f ? q = {
        paddingTop: "1rem"
      } : q = {};
      F = o.a.createElement("div", {
        ...
        className: "frmae_qrcode__tit"
      }, (null == N ? 0 : N.title) || ""), o.a.createElement("div", {
        className: "frmae_qrcode__qrcode " + (E || I || T || R || !w ? "disable" : "")
        ...
        className: "frmae_qrcode__sub_tit"
      }, (null == N ? 0 : N.subtitle) || ""), o.a.createElement("div", {
        className: "frmae_qrcode__desc"
      }, (null == N ? 0 : N.desc) || ""));
      return c.f ? F : o.a.createElement("div", {
        className: "mod_popup"
      }, o.a.createElement("div", {
